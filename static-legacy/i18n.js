...
const LOCALES = {
  en: {
    ...
    profile_mcp_desc: 'MCP servers stored in this profile config.yaml.',
    profile_mcp_reload_hint: 'MCP servers connect automatically when you open this tab or save changes.',
    mcp_status_error: 'Connect failed',
    mcp_connect_failed_summary: 'Some MCP servers failed to connect',
    mcp_updating: 'Updating connection status…',
    mcp_connecting: 'Connecting MCP servers…',
    mcp_input_form: 'Form',
    mcp_json_label: 'MCP server JSON',
    mcp_json_hint: 'Paste one or more servers keyed by name, as in config.yaml mcp_servers.',
    mcp_json_required: 'JSON is required.',
    mcp_json_invalid: 'Invalid JSON.',
    mcp_json_object_required: 'JSON must be an object.',
    mcp_json_no_servers: 'No MCP server entries found in JSON.',
    mcp_json_entry_invalid: 'Invalid config for server',
    mcp_json_entry_missing_transport: 'Each server needs url or command',
    mcp_json_edit_single: 'Edit JSON must contain only the current server name.',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    tab_kanban: 'Kanban',
    kanban_subtitle: 'Durable multi-agent board for tasks the agent can pick up and finish on its own.',
    kanban_dispatch: 'Dispatch',
    kanban_board: 'Board',
    ...
    kanban_priority_hint: 'Higher priority runs first. Normal is the default.',
    ...
    insights_logs_scope_label: 'User scope',
    insights_logs_scope_all: 'All users (combined)',
    ...
    workspace_desc: 'Each profile has one workspace, created automatically.',
    ...
    workspaces_empty_sub: 'Each profile has one workspace, created automatically when the profile is created.',
    ...
    workspace_one_per_profile: 'Each profile has one workspace, created automatically under the profile directory.',
    workspace_nested_hint: 'Create sub-workspaces under /workspace (folders inside your profile workspace). The root /workspace entry cannot be removed.',
    workspace_nested_create_hint: 'Enter a folder name (e.g. project1). It will be created under your /workspace root or the selected parent.',
    workspace_nested_path_preview: 'Displayed paths use /workspace as the root.',
    workspace_nested_name_placeholder: 'project1',
    workspace_parent_label: 'Parent workspace',
    workspace_name_required: 'Name is required',
    workspace_add_blocked: 'Each profile can only have one workspace.',
    workspace_remove_blocked: 'The profile workspace cannot be removed.',
    ...
    profile_clone_label: 'Settings, skills, and config are copied from the default profile. Adjust them after creation from the profile detail view.',
    ...
    profile_sync_from_default_title: 'Update from default',
    profile_sync_from_default_hint: 'Copy missing config, MCP servers, skills, and agent soul paragraphs from the default profile. Your existing settings and SOUL content stay unchanged.',
    profile_sync_from_default_confirm_title: (name) => `Update "${name}" from default?`,
    profile_sync_from_default_confirm_message: 'Only items missing in this profile will be copied from the default profile.',
    profile_sync_from_default_done: (name) => `Profile updated from default: ${name}`,
    profile_sync_all_from_default_title: 'Update all profiles from default',
    profile_sync_all_from_default_confirm_title: 'Update all profiles from default?',
    profile_sync_all_from_default_confirm_message: 'Every non-default profile will receive missing config, MCP servers, skills, and agent soul from the default profile. Existing profile settings stay unchanged.',
    profile_sync_all_from_default_done: (count) => `Updated ${count} profile${count === 1 ? '' : 's'} from default`,
    profile_sync_failed: 'Failed to update profile: ',

    profile_sync_panel_hint: 'Use refresh to copy missing config, MCP, skills, and agent soul from the default profile.',
    profile_sync_items_label: 'Synced items',
    profile_sync_items_config: 'Config',
    profile_sync_items_mcp: 'MCP servers',
    profile_sync_items_skills: 'Skills',
    profile_sync_items_soul: 'Agent soul',
    profile_sync_added_config: (count) => `${count} config ${count === 1 ? 'key' : 'keys'}`,
    profile_sync_added_mcp: (count) => `${count} MCP ${count === 1 ? 'server' : 'servers'}`,
    profile_sync_added_skills: (count) => `${count} ${count === 1 ? 'skill' : 'skills'}`,
    profile_sync_added_soul: (count) => `${count} soul ${count === 1 ? 'file' : 'files'}`,
    profile_sync_result_added: (summary) => `Added from default: ${summary}`,
    profile_sync_result_none: 'Already up to date — nothing new to copy from default.',
  ...
  it: {
    ...
    mcp_edit_server: 'Modifica Server MCP',
    profile_tab_overview: 'Panoramica',
    profile_mcp_desc: 'Server MCP memorizzati nel config.yaml di questo profilo.',
    profile_mcp_reload_hint: 'I server MCP si connettono automaticamente quando apri questa scheda o salvi le modifiche.',
    mcp_status_error: 'Connessione fallita',
    mcp_connect_failed_summary: 'Alcuni server MCP non si sono connessi',
    mcp_updating: 'Aggiornamento stato connessione…',
    mcp_connecting: 'Connessione ai server MCP…',
    mcp_input_form: 'Modulo',
    mcp_json_label: 'JSON server MCP',
    mcp_json_hint: 'Incolla uno o più server con nome come chiave, come in config.yaml mcp_servers.',
    mcp_json_required: 'JSON obbligatorio.',
    mcp_json_invalid: 'JSON non valido.',
    mcp_json_object_required: 'Il JSON deve essere un oggetto.',
    mcp_json_no_servers: 'Nessuna voce server MCP trovata nel JSON.',
    mcp_json_entry_invalid: 'Configurazione non valida per il server',
    mcp_json_entry_missing_transport: 'Ogni server richiede url o command',
    mcp_json_edit_single: 'Il JSON modificato deve contenere solo il nome del server corrente.',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    tab_kanban: 'Kanban',
    kanban_subtitle: 'Bacheca multi-agente persistente per i task che l\'agente può raccogliere e completare in autonomia.',
    kanban_dispatch: 'Dispatch',
    ...
    kanban_priority_low: 'Bassa',
    kanban_priority_normal: 'Normale',
    kanban_priority_high: 'Alta',
    kanban_priority_urgent: 'Urgente',
    kanban_priority_hint: 'Priorità più alta viene eseguita prima. Normale è il valore predefinito.',
    ...
    logs_severity: 'Gravità',
    logs_severity_all: 'Tutti',
    logs_severity_errors: 'Errori',
    logs_severity_warnings: 'Avvisi+',
    logs_filter_active: 'mostrati (filtro attivo)',
    ...
    workspace_one_per_profile: 'Ogni profilo ha un workspace, creato automaticamente nella directory del profilo.',
    workspace_add_blocked: 'Ogni profilo può avere un solo workspace.',
    workspace_remove_blocked: 'Il workspace del profilo non può essere rimosso.',
  ...
  ja: {
    ...
    mcp_edit_server: 'MCPサーバーを編集',
    profile_tab_overview: '概要',
    profile_mcp_desc: 'このプロファイルの config.yaml に保存された MCP サーバー。',
    profile_mcp_reload_hint: 'このタブを開くか変更を保存すると MCP サーバーが自動的に接続されます。',
    mcp_status_error: '接続に失敗',
    mcp_connect_failed_summary: '一部の MCP サーバーの接続に失敗しました',
    mcp_updating: '接続状態を更新中…',
    mcp_connecting: 'MCPサーバーに接続中…',
    mcp_input_form: 'フォーム',
    mcp_json_label: 'MCPサーバー JSON',
    mcp_json_hint: 'config.yaml の mcp_servers と同様に、名前をキーとして1つ以上のサーバーを貼り付けます。',
    mcp_json_required: 'JSON は必須です。',
    mcp_json_invalid: 'JSON が無効です。',
    mcp_json_object_required: 'JSON はオブジェクトである必要があります。',
    mcp_json_no_servers: 'JSON に MCP サーバーのエントリが見つかりません。',
    mcp_json_entry_invalid: 'サーバーの設定が無効です',
    mcp_json_entry_missing_transport: '各サーバーには url または command が必要です',
    mcp_json_edit_single: '編集 JSON には現在のサーバー名のみを含める必要があります。',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    tab_profiles: 'プロファイル',
    tab_kanban: 'カンバン',
    kanban_subtitle: 'エージェントが自律的に拾って完了できるタスク向けの永続的多エージェントボード。',
    kanban_dispatch: 'ディスパッチ',
    kanban_board: 'ボード',
    ...
    kanban_priority_normal: '通常',
    kanban_priority_high: '高',
    kanban_priority_urgent: '緊急',
    kanban_priority_hint: '優先度が高いほど先に実行されます。既定は通常です。',
    ...
    workspace_one_per_profile: '各プロファイルにはプロファイルディレクトリ下に自動作成されるワークスペースが1つあります。',
    workspace_add_blocked: '各プロファイルはワークスペースを1つだけ持てます。',
    workspace_remove_blocked: 'プロファイルのワークスペースは削除できません。',
  ...
  ru: {
    ...
    mcp_edit_server: 'Редактировать MCP-сервер',
    profile_tab_overview: 'Обзор',
    profile_mcp_desc: 'MCP-серверы, сохранённые в config.yaml этого профиля.',
    profile_mcp_reload_hint: 'MCP-серверы подключаются автоматически при открытии этой вкладки или сохранении изменений.',
    mcp_status_error: 'Ошибка подключения',
    mcp_connect_failed_summary: 'Не удалось подключить некоторые MCP-серверы',
    mcp_updating: 'Обновление статуса подключения…',
    mcp_connecting: 'Подключение MCP-серверов…',
    mcp_input_form: 'Форма',
    mcp_json_label: 'JSON MCP-сервера',
    mcp_json_hint: 'Вставьте один или несколько серверов с именем в качестве ключа, как в config.yaml mcp_servers.',
    mcp_json_required: 'Требуется JSON.',
    mcp_json_invalid: 'Недопустимый JSON.',
    mcp_json_object_required: 'JSON должен быть объектом.',
    mcp_json_no_servers: 'В JSON не найдены записи MCP-серверов.',
    mcp_json_entry_invalid: 'Недопустимая конфигурация для сервера',
    mcp_json_entry_missing_transport: 'Каждому серверу нужны url или command',
    mcp_json_edit_single: 'JSON редактирования должен содержать только имя текущего сервера.',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    kanban_priority_urgent: 'Срочный',
    kanban_priority_hint: 'Более высокий приоритет выполняется первым. По умолчанию — обычный.',
    ...
    workspace_one_per_profile: 'У каждого профиля один workspace, создаваемый автоматически в каталоге профиля.',
    workspace_add_blocked: 'У каждого профиля может быть только один workspace.',
    workspace_remove_blocked: 'Workspace профиля нельзя удалить.',
  ...
  es: {
    ...
    mcp_edit_server: 'Editar servidor MCP',
    profile_tab_overview: 'Resumen',
    profile_mcp_desc: 'Servidores MCP almacenados en el config.yaml de este perfil.',
    profile_mcp_reload_hint: 'Los servidores MCP se conectan automáticamente al abrir esta pestaña o guardar cambios.',
    mcp_status_error: 'Error de conexión',
    mcp_connect_failed_summary: 'Algunos servidores MCP no se conectaron',
    mcp_updating: 'Actualizando estado de conexión…',
    mcp_connecting: 'Conectando servidores MCP…',
    mcp_input_form: 'Formulario',
    mcp_json_label: 'JSON del servidor MCP',
    mcp_json_hint: 'Pegue uno o más servidores con nombre como clave, como en config.yaml mcp_servers.',
    mcp_json_required: 'Se requiere JSON.',
    mcp_json_invalid: 'JSON no válido.',
    mcp_json_object_required: 'El JSON debe ser un objeto.',
    mcp_json_no_servers: 'No se encontraron entradas de servidor MCP en el JSON.',
    mcp_json_entry_invalid: 'Configuración no válida para el servidor',
    mcp_json_entry_missing_transport: 'Cada servidor necesita url o command',
    mcp_json_edit_single: 'El JSON de edición debe contener solo el nombre del servidor actual.',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    kanban_priority_low: 'Baja',
    kanban_priority_normal: 'Normal',
    kanban_priority_high: 'Alta',
    kanban_priority_urgent: 'Urgente',
    kanban_priority_hint: 'Mayor prioridad se ejecuta primero. Normal es el valor predeterminado.',
  ...
  de: {
    ...
    mcp_edit_server: 'MCP-Server bearbeiten',
    profile_tab_overview: 'Übersicht',
    profile_mcp_desc: 'MCP-Server in der config.yaml dieses Profils.',
    profile_mcp_reload_hint: 'MCP-Server verbinden sich automatisch, wenn Sie diesen Tab öffnen oder Änderungen speichern.',
    mcp_status_error: 'Verbindung fehlgeschlagen',
    mcp_connect_failed_summary: 'Einige MCP-Server konnten nicht verbunden werden',
    mcp_updating: 'Verbindungsstatus wird aktualisiert…',
    mcp_connecting: 'MCP-Server werden verbunden…',
    mcp_input_form: 'Formular',
    mcp_json_label: 'MCP-Server-JSON',
    mcp_json_hint: 'Fügen Sie einen oder mehrere Server mit Namen als Schlüssel ein, wie in config.yaml mcp_servers.',
    mcp_json_required: 'JSON ist erforderlich.',
    mcp_json_invalid: 'Ungültiges JSON.',
    mcp_json_object_required: 'JSON muss ein Objekt sein.',
    mcp_json_no_servers: 'Keine MCP-Server-Einträge im JSON gefunden.',
    mcp_json_entry_invalid: 'Ungültige Konfiguration für Server',
    mcp_json_entry_missing_transport: 'Jeder Server benötigt url oder command',
    mcp_json_edit_single: 'Bearbeitungs-JSON darf nur den aktuellen Servernamen enthalten.',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    kanban_priority_low: 'Niedrig',
    kanban_priority_normal: 'Normal',
    kanban_priority_high: 'Hoch',
    kanban_priority_urgent: 'Dringend',
    kanban_priority_hint: 'Höhere Priorität wird zuerst ausgeführt. Normal ist der Standard.',
    ...
    workspace_one_per_profile: 'Jedes Profil hat einen Workspace, der automatisch im Profilverzeichnis erstellt wird.',
    workspace_add_blocked: 'Jedes Profil kann nur einen Workspace haben.',
    workspace_remove_blocked: 'Der Profil-Workspace kann nicht entfernt werden.',
  ...
  zh: {
    ...
    profile_mcp_desc: '存储在此配置文件 config.yaml 中的 MCP 服务器。',
    profile_mcp_reload_hint: '打开此标签页或保存更改时，MCP 服务器会自动连接。',
    mcp_status_error: '连接失败',
    mcp_connect_failed_summary: '部分 MCP 服务器连接失败',
    mcp_updating: '正在更新连接状态…',
    mcp_connecting: '正在连接 MCP 服务器…',
    mcp_input_form: '表单',
    mcp_json_label: 'MCP 服务器 JSON',
    mcp_json_hint: '粘贴一个或多个以名称为键的服务器，与 config.yaml 中的 mcp_servers 相同。',
    mcp_json_required: '需要 JSON。',
    mcp_json_invalid: 'JSON 无效。',
    mcp_json_object_required: 'JSON 必须是对象。',
    mcp_json_no_servers: 'JSON 中未找到 MCP 服务器条目。',
    mcp_json_entry_invalid: '服务器配置无效',
    mcp_json_entry_missing_transport: '每个服务器需要 url 或 command',
    mcp_json_edit_single: '编辑 JSON 只能包含当前服务器名称。',
    mcp_field_name: '服务器名称',
    mcp_transport_label: '传输类型',
    mcp_field_command: '命令',
    mcp_field_args: '参数（逗号分隔）',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    tab_tasks: '任务',
    tab_kanban: '看板',
    kanban_subtitle: '持久化多智能体看板，用于代理可自主领取并完成的任务。',
    kanban_dispatch: '调度',
    kanban_board: '看板',
    ...
    kanban_priority: '优先级',
    kanban_priority_low: '低',
    kanban_priority_normal: '普通',
    kanban_priority_high: '高',
    kanban_priority_urgent: '紧急',
    kanban_priority_hint: '优先级越高越先执行，默认为普通。',
    ...
    workspace_one_per_profile: '每个配置文件有一个工作区，会在配置文件目录下自动创建。',
    workspace_add_blocked: '每个配置文件只能有一个工作区。',
    workspace_remove_blocked: '无法移除配置文件的工作区。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    tab_workspaces: '\u5de5\u4f5c\u5340',
    tab_kanban: 'Kanban',
    kanban_subtitle: '持久化多代理看板，供代理自主領取並完成的任務。',
    kanban_dispatch: '調度',
    kanban_board: '看板',
    ...
    kanban_priority_high: '高',
    kanban_priority_urgent: '緊急',
    kanban_priority_hint: '優先順序越高越先執行，預設為普通。',
  ...
  pt: {
    ...
    kanban_priority_low: 'Baixa',
    kanban_priority_normal: 'Normal',
    kanban_priority_high: 'Alta',
    kanban_priority_urgent: 'Urgente',
    kanban_priority_hint: 'Prioridade mais alta executa primeiro. Normal é o padrão.',
  ...
  ko: {
    ...
    mcp_no_servers: 'No MCP servers configured.',
    mcp_add_server: '+ Add Server',
    mcp_edit_server: 'MCP 서버 편집',
    profile_tab_overview: '개요',
    profile_mcp_desc: '이 프로필 config.yaml에 저장된 MCP 서버.',
    profile_mcp_reload_hint: '이 탭을 열거나 변경 사항을 저장하면 MCP 서버가 자동으로 연결됩니다.',
    mcp_status_error: '연결 실패',
    mcp_connect_failed_summary: '일부 MCP 서버 연결에 실패했습니다',
    mcp_updating: '연결 상태 업데이트 중…',
    mcp_connecting: 'MCP 서버 연결 중…',
    mcp_input_form: '양식',
    mcp_json_label: 'MCP 서버 JSON',
    mcp_json_hint: 'config.yaml mcp_servers와 같이 이름을 키로 하는 서버를 하나 이상 붙여넣으세요.',
    mcp_json_required: 'JSON이 필요합니다.',
    mcp_json_invalid: '잘못된 JSON입니다.',
    mcp_json_object_required: 'JSON은 객체여야 합니다.',
    mcp_json_no_servers: 'JSON에서 MCP 서버 항목을 찾을 수 없습니다.',
    mcp_json_entry_invalid: '서버 구성이 잘못되었습니다',
    mcp_json_entry_missing_transport: '각 서버에는 url 또는 command가 필요합니다',
    mcp_json_edit_single: '편집 JSON에는 현재 서버 이름만 포함해야 합니다.',
    mcp_field_name: 'Server Name',
    mcp_transport_label: 'Transport Type',
    mcp_field_command: 'Command',
    mcp_field_args: 'Arguments (comma-separated)',
    ...
    kanban_priority_low: '낮음',
    kanban_priority_normal: '보통',
    kanban_priority_high: '높음',
    kanban_priority_urgent: '긴급',
    kanban_priority_hint: '우선순위가 높을수록 먼저 실행됩니다. 기본값은 보통입니다.',
  ...
  fr: {
    ...
    mcp_edit_server: 'Modifier le serveur MCP',
    profile_tab_overview: 'Aperçu',
    profile_mcp_desc: 'Serveurs MCP stockés dans le config.yaml de ce profil.',
    profile_mcp_reload_hint: 'Les serveurs MCP se connectent automatiquement lorsque vous ouvrez cet onglet ou enregistrez les modifications.',
    mcp_status_error: 'Échec de la connexion',
    mcp_connect_failed_summary: 'Certains serveurs MCP n\'ont pas pu se connecter',
    mcp_updating: 'Mise à jour du statut de connexion…',
    mcp_connecting: 'Connexion aux serveurs MCP…',
    mcp_input_form: 'Formulaire',
    mcp_json_label: 'JSON du serveur MCP',
    mcp_json_hint: 'Collez un ou plusieurs serveurs nommés par clé, comme dans config.yaml mcp_servers.',
    mcp_json_required: 'JSON requis.',
    mcp_json_invalid: 'JSON invalide.',
    mcp_json_object_required: 'Le JSON doit être un objet.',
    mcp_json_no_servers: 'Aucune entrée de serveur MCP trouvée dans le JSON.',
    mcp_json_entry_invalid: 'Configuration invalide pour le serveur',
    mcp_json_entry_missing_transport: 'Chaque serveur a besoin d\'url ou de command',
    mcp_json_edit_single: 'Le JSON d\'édition ne doit contenir que le nom du serveur actuel.',
    ...
    tab_kanban: 'Kanban',
    kanban_subtitle: 'Tableau multi-agents durable pour les tâches que l\'agent peut prendre en charge et terminer de lui-même.',
    kanban_dispatch: 'Dispatcher',
    ...
    kanban_priority_low: 'Basse',
    kanban_priority_normal: 'Normale',
    kanban_priority_high: 'Haute',
    kanban_priority_urgent: 'Urgente',
    kanban_priority_hint: 'Les priorités plus élevées passent en premier. Normale par défaut.',
    ...
    workspace_one_per_profile: 'Chaque profil a un espace de travail, créé automatiquement dans le répertoire du profil.',
    workspace_add_blocked: 'Chaque profil ne peut avoir qu\'un seul espace de travail.',
    workspace_remove_blocked: 'L\'espace de travail du profil ne peut pas être supprimé.',
  ...
  th: {
    offline_title: 'ขาดการเชื่อมต่อ',
    offline_browser_detail: 'เบราว์เซอร์รายงานว่าอุปกรณ์นี้ออฟไลน์',
    offline_network_detail: 'ไม่สามารถเชื่อมต่อ Hermes จากเบราว์เซอร์นี้ได้ในขณะนี้',
    offline_autorefresh: 'หน้านี้จะรีเฟรชอัตโนมัติเมื่อ Hermes พร้อมใช้งานอีกครั้ง',
    offline_check_now: 'ตรวจสอบตอนนี้',
    offline_checking: 'กำลังตรวจสอบ\u2026',
    offline_stream_waiting: 'ขาดการเชื่อมต่อ กำลังรอรีเฟรช\u2026',
    _lang: 'th',
    _label: 'ไทย',
    _speech: 'th-TH',
    // boot.js
    ...
    mic_denied: 'ไม่ได้รับอนุญาตใช้ไมโครโฟน ตรวจสอบสิทธิ์ของเบราว์เซอร์',
    mic_no_speech: 'ไม่พบเสียงพูด ลองอีกครั้ง',
    mic_network: 'ไม่สามารถใช้การรู้จำเสียงได้',
    mic_error: 'ข้อผิดพลาดการป้อนเสียง: ',
    // Composer voice buttons (#1488 — distinct labels for dictation vs voice mode)
    voice_dictate: 'พิมพ์ด้วยเสียง',
    voice_dictate_active: 'หยุดพิมพ์ด้วยเสียง',
    voice_mode_toggle: 'โหมดเสียง',
    voice_mode_toggle_active: 'ออกจากโหมดเสียง',
    // Turn-based voice mode (#1333)
    voice_listening: 'กำลังฟัง\u2026',
    voice_speaking: 'กำลังพูด\u2026',
    voice_thinking: 'กำลังคิด\u2026',
    voice_error: 'ไม่รองรับเสียงในเบราว์เซอร์นี้',
    voice_mode_active: 'เปิดโหมดเสียงแล้ว',
    voice_mode_off: 'ปิดโหมดเสียงแล้ว',
    session_imported: 'นำเข้าเซสชันแล้ว',
    import_failed: 'นำเข้าไม่สำเร็จ: ',
    import_invalid_json: 'JSON ไม่ถูกต้อง',
    image_pasted: 'วางรูปภาพแล้ว: ',
    // messages.js
    ...
    selected_text_reply: 'ตอบด้วยข้อความที่เลือก',
    selected_text_reply_title: 'แนบข้อความที่เลือกจากแชทเป็นบริบทอ้างอิง',
    selected_text_reply_appended: 'เพิ่มข้อความที่เลือกในช่องพิมพ์แล้ว',

    diff_loading: 'กำลังโหลด diff',
    diff_error: 'โหลดไฟล์ patch ไม่ได้',
    diff_too_large: 'ไฟล์ patch ใหญ่เกินไปที่จะแสดงในหน้า',
    tree_view: 'ต้นไม้',
    raw_view: 'ดิบ',
    parse_failed_note: 'แปลงไม่สำเร็จ',
    you: 'คุณ',
    mcp_servers_title: 'MCP Servers',
    mcp_servers_desc: 'ดู MCP servers ที่ตั้งค่าใน config.yaml',
    mcp_no_servers: 'ยังไม่ได้ตั้งค่า MCP server',
    mcp_add_server: '+ เพิ่ม Server',
    mcp_edit_server: 'แก้ไข MCP Server',
    profile_tab_overview: 'ภาพรวม',
    profile_mcp_desc: 'MCP servers ที่เก็บใน config.yaml ของโปรไฟล์นี้',
    profile_mcp_reload_hint: 'MCP servers จะเชื่อมต่ออัตโนมัติเมื่อเปิดแท็บนี้หรือบันทึกการเปลี่ยนแปลง',
    mcp_status_error: 'เชื่อมต่อไม่สำเร็จ',
    mcp_connect_failed_summary: 'MCP server บางตัวเชื่อมต่อไม่สำเร็จ',
    mcp_updating: 'กำลังอัปเดตสถานะการเชื่อมต่อ\u2026',
    mcp_connecting: 'กำลังเชื่อมต่อ MCP servers\u2026',
    mcp_input_form: 'ฟอร์ม',
    mcp_json_label: 'JSON ของ MCP server',
    mcp_json_hint: 'วาง server อย่างน้อยหนึ่งตัวโดยใช้ชื่อเป็น key ตาม config.yaml mcp_servers',
    mcp_json_required: 'ต้องระบุ JSON',
    mcp_json_invalid: 'JSON ไม่ถูกต้อง',
    mcp_json_object_required: 'JSON ต้องเป็น object',
    mcp_json_no_servers: 'ไม่พบรายการ MCP server ใน JSON',
    mcp_json_entry_invalid: 'การตั้งค่า server ไม่ถูกต้อง',
    mcp_json_entry_missing_transport: 'แต่ละ server ต้องมี url หรือ command',
    mcp_json_edit_single: 'JSON ที่แก้ไขต้องมีเฉพาะชื่อ server ปัจจุบัน',
    mcp_field_name: 'ชื่อ Server',
    mcp_transport_label: 'ประเภท Transport',
    mcp_field_command: 'Command',
    mcp_field_args: 'อาร์กิวเมนต์ (คั่นด้วยจุลภาค)',
    mcp_field_url: 'URL',
    mcp_field_timeout: 'Timeout (วินาที)',
    mcp_save: 'บันทึก',
    mcp_cancel: 'ยกเลิก',
    mcp_name_required: 'ต้องระบุชื่อ server',
    mcp_url_required: 'ต้องระบุ URL สำหรับ HTTP transport',
    mcp_command_required: 'ต้องระบุ command สำหรับ stdio transport',
    mcp_saved: 'บันทึก MCP server แล้ว',
    mcp_save_failed: 'บันทึก MCP server ไม่สำเร็จ',
    mcp_delete_confirm_title: 'ลบ MCP Server',
    mcp_delete_confirm_message: 'ลบ MCP server "{0}" หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้',
    mcp_deleted: 'ลบ MCP server แล้ว',
    mcp_delete_failed: 'ลบ MCP server ไม่สำเร็จ',
    mcp_load_failed: 'โหลด MCP servers ไม่สำเร็จ',
    mcp_restart_hint: 'การเปลี่ยน server ที่นี่เป็นแบบอ่านอย่างเดียวชั่วคราว แก้ config.yaml แล้วรีสตาร์ท Hermes เพื่อให้มีผล',
    mcp_toggle_followup: 'ปุ่มเปิด/ปิดถูกเลื่อนออกไปจนกว่าจะกำหนดพฤติกรรม MCP reload ให้ชัดเจน',
    mcp_status_active: 'ใช้งาน',
    mcp_status_configured: 'ตั้งค่าแล้ว',
    mcp_status_disabled: 'ปิดใช้งาน',
    mcp_status_invalid_config: 'การตั้งค่าไม่ถูกต้อง',
    mcp_status_unknown: 'ไม่ทราบ',
    mcp_tool_count: '{0} เครื่องมือ',
    mcp_enabled_yes: 'เปิดใช้งาน',
    mcp_enabled_no: 'ปิดใช้งาน',
    mcp_enable_server: 'เปิดใช้งาน MCP server นี้',
    mcp_disable_server: 'ปิดใช้งาน MCP server นี้',
    mcp_enabled_toast: (name) => `เปิดใช้งาน MCP server "${name}" แล้ว`,
    mcp_disabled_toast: (name) => `ปิดใช้งาน MCP server "${name}" แล้ว`,
    mcp_toggle_failed: 'อัปเดต MCP server ไม่สำเร็จ',
    mcp_tools_title: 'MCP Tools',
    mcp_tools_desc: 'ค้นหาเครื่องมือที่รู้จักจาก MCP servers ที่ใช้งานอยู่',
    mcp_tools_search_placeholder: 'ค้นหาเครื่องมือตามชื่อ server หรือคำอธิบาย\u2026',
    mcp_tools_no_tools: 'ไม่มี MCP tools จาก runtime inventory ที่ใช้งานอยู่',
    mcp_tools_no_matches: 'ไม่พบ MCP tools ที่ตรงกับการค้นหา',
    mcp_tools_load_failed: 'โหลด MCP tools ไม่สำเร็จ',
    mcp_tools_schema_empty: 'ไม่มีพารามิเตอร์ schema',
    mcp_tools_runtime_note: 'รายการเครื่องมือใช้เฉพาะข้อมูล MCP runtime ที่รู้จักแล้ว WebUI ไม่ได้เริ่มหรือ probe servers',
    mcp_tools_summary_no_matches: (query,total) => `ไม่พบ MCP tools ที่ตรงกับ “${query}” (${total} MCP tools ทั้งหมด)`,
    mcp_tools_summary_none: 'ไม่มี MCP tools ให้แสดง',
    mcp_tools_summary_matching: (query) => ` ที่ตรงกับ “${query}”`,
    mcp_tools_summary_total_note: (total) => ` (${total} MCP tools ทั้งหมด)`,
    mcp_tools_summary_showing: (start,end,filtered,searchNote,totalNote,page,pages) => `แสดง ${start}-${end} จาก ${filtered} MCP tools${searchNote}${totalNote} หน้า ${page} จาก ${pages}`,
    mcp_tools_page_size_prefix: 'แสดง',
    mcp_tools_page_size_suffix: 'ต่อหน้า',
    mcp_tools_per_page_aria: 'จำนวน MCP tools ต่อหน้า',
    mcp_tools_inactive_configured_servers: (servers) => `ตั้งค่าแล้วแต่ไม่ใช้งานใน WebUI runtime นี้: ${servers}`,
    mcp_tools_pagination_label: 'การแบ่งหน้า MCP tools',
    mcp_tools_previous_page: '‹ ก่อนหน้า',
    mcp_tools_previous_page_aria: 'หน้า MCP tools ก่อนหน้า',
    mcp_tools_next_page: 'ถัดไป ›',
    mcp_tools_next_page_aria: 'หน้า MCP tools ถัดไป',
    // PDF preview (#480)
    pdf_loading: 'กำลังโหลด PDF {0}\u2026',
    pdf_too_large: 'PDF ใหญ่เกินไปสำหรับแสดงในหน้า',
    pdf_no_pages: 'PDF ไม่มีหน้า',
    pdf_error: 'แสดงตัวอย่าง PDF ไม่สำเร็จ',
    pdf_download: 'ดาวน์โหลด PDF',
    // HTML sandbox preview (#482)
    html_loading: 'กำลังโหลดตัวอย่าง HTML\u2026',
    html_too_large: 'HTML ใหญ่เกินไปสำหรับแสดงในหน้า',
    html_error: 'แสดงตัวอย่าง HTML ไม่สำเร็จ',
    html_open_full: 'เปิดหน้าเต็ม',
    html_sandbox_label: 'ตัวอย่าง HTML (sandbox)',
    thinking: 'กำลังคิด',
    expand_all: 'ขยายทั้งหมด',
    collapse_all: 'ย่อทั้งหมด',
    edit_failed: 'แก้ไขไม่สำเร็จ: ',
    regen_failed: 'สร้างใหม่ไม่สำเร็จ: ',
    reconnect_active: 'ยังมีการสร้างคำตอบอยู่ รีโหลดเมื่อพร้อมหรือไม่?',
    reconnect_finished: 'มีคำตอบที่กำลังดำเนินการเมื่อคุณออกไป ข้อความอาจมีการอัปเดต',
    // approval card
    approval_heading: 'ต้องการการอนุมัติ',
    approval_desc_prefix: 'ตรวจพบคำสั่งที่อันตราย',
    approval_btn_once: 'อนุญาตครั้งเดียว',
    approval_btn_once_title: 'อนุญาตคำสั่งนี้ครั้งเดียว (Enter)',
    approval_btn_session: 'อนุญาตในเซสชัน',
    approval_btn_session_title: 'อนุญาตสำหรับบทสนทนานี้',
    approval_btn_always: 'อนุญาตเสมอ',
    approval_btn_always_title: 'อนุญาตรูปแบบคำสั่งนี้เสมอ',
    approval_btn_deny: 'ปฏิเสธ',
    approval_btn_deny_title: 'ปฏิเสธ — ไม่รันคำสั่งนี้',
    approval_responding: 'กำลังตอบ\u2026',
    clarify_heading: 'ต้องการข้อมูลเพิ่มเติม',
    clarify_hint: 'เลือกตัวเลือก หรือพิมพ์คำตอบของคุณด้านล่าง',
    clarify_other: 'อื่นๆ',
    clarify_send: 'ส่ง',
    clarify_input_placeholder: 'พิมพ์คำตอบของคุณ\u2026',
    clarify_responding: 'กำลังตอบ\u2026',
    untitled: 'ไม่มีชื่อ',
    n_messages: (n) => `${n} ข้อความ`,
    load_older_messages: '↑ เลื่อนขึ้นหรือคลิกเพื่อโหลดข้อความเก่า',
    session_jump_start: 'ต้น',
    session_jump_start_label: 'ไปจุดเริ่มต้นของเซสชัน',
    session_jump_end: 'ท้าย',
    session_jump_end_label: 'ไปจุดสิ้นสุดของเซสชัน',
    jump_to_question: 'ไปยังคำถาม',
    jump_to_question_label: 'ไปยังคำถามของคำตอบนี้',
    queued_label: 'ส่งหลังคำตอบเสร็จ',
    queued_count: (n) => n === 1 ? '1 รายการในคิว' : `${n} รายการในคิว`,
    queued_cancel: 'ยกเลิกข้อความในคิว',
    model_unavailable: ' (ไม่พร้อมใช้งาน)',
    model_unavailable_title: 'โมเดลนี้ไม่อยู่ในรายการ provider ปัจจุบัน',
    provider_mismatch_warning: (m,p)=>`"${m}" อาจใช้ไม่ได้กับ provider ที่ตั้งค่า (${p}) ส่งต่อไปหรือเปลี่ยนโมเดล?`,
    provider_mismatch_label: 'Provider ไม่ตรงกัน',
    model_not_found_label: 'ไม่พบโมเดล',
    model_custom_label: 'รหัสโมเดลกำหนดเอง',
    model_custom_placeholder: 'เช่น openai/gpt-5.4',
    model_search_placeholder: 'ค้นหาโมเดล\u2026',
    model_search_no_results: 'ไม่พบโมเดล',
    model_group_configured: 'ตั้งค่าแล้ว',
    ws_search_placeholder: 'ค้นหา workspace\u2026',
    ws_no_results: 'ไม่พบ workspace',
    workspace_new_worktree_conversation: 'บทสนทนาใหม่ใน worktree',
    workspace_new_worktree_conversation_meta: 'สร้าง git worktree แยกสำหรับ workspace นี้',
    workspace_worktree_created: 'สร้างบทสนทนา worktree แล้ว',
    workspace_worktree_failed: 'สร้าง worktree ไม่สำเร็จ: ',
    session_worktree_badge: 'Worktree',
    model_scope_advisory: 'มีผลกับบทสนทนานี้ตั้งแต่ข้อความถัดไป',
    model_scope_toast: 'มีผลกับบทสนทนานี้ตั้งแต่ข้อความถัดไป',
    // commands.js
    cmd_clear: 'ล้างข้อความในบทสนทนา',
    cmd_compress: 'บีบอัดบริบทบทสนทนาด้วยตนเอง (ใช้: /compress [หัวข้อ])',
    ctx_compress_hint: 'บีบอัดบริบทเพื่อเพิ่มพื้นที่ →',
    ctx_compress_action: '⚠ บีบอัดตอนนี้เพื่อเพิ่มบริบท',
    cmd_compact_alias: 'ชื่อเก่าของ /compress',
    cmd_model: 'สลับโมเดล (เช่น /model gpt-4o)',
    cmd_workspace: 'สลับ workspace ตามชื่อ',
    cmd_terminal: 'เปิดเทอร์มินัลของ workspace',
    cmd_new: 'เริ่มเซสชันแชทใหม่',
    cmd_usage: 'สลับการแสดงการใช้โทเค็น',
    cmd_theme: 'สลับรูปลักษณ์ (theme: system/dark/light, skin: default/ares/mono/slate/poseidon)',
    cmd_personality: 'สลับบุคลิก agent',
    cmd_skills: 'แสดง Hermes skills ที่มี',
    available_commands: 'คำสั่งที่ใช้ได้:',
    type_slash: 'พิมพ์ / เพื่อดูคำสั่ง',
    conversation_cleared: 'ล้างบทสนทนาแล้ว',
    command_label: 'คำสั่ง',
    context_compaction_label: 'การบีบอัดบริบท',
    retrieval_context_label: 'บริบทที่จัดทำดัชนี',
    retrieval_context_preview: 'ข้อความก่อนหน้านี้ถูกเก็บและเรียกคืนได้ด้วยเครื่องมือบริบท',
    preserved_task_list_label: 'รายการงานที่เก็บไว้',
    reference_only_label: 'อ้างอิงเท่านั้น',
    model_usage: 'วิธีใช้: /model <name>',
    no_model_match: 'ไม่พบโมเดลที่ตรงกับ "',
    switched_to: 'สลับเป็น ',
    workspace_usage: 'วิธีใช้: /workspace <name>',
    no_workspace_match: 'ไม่พบ workspace ที่ตรงกับ "',
    switched_workspace: 'สลับไป workspace: ',
    workspace_switch_failed: 'สลับ workspace ไม่สำเร็จ: ',
    new_session: 'สร้างเซสชันใหม่แล้ว',
    new_session_creating: 'กำลังสร้างบทสนทนาใหม่\u2026',
    compressing: 'กำลังขอบีบอัดบริบท...',
    compress_running_label: 'กำลังบีบอัด',
    compress_complete_label: 'บีบอัดเสร็จแล้ว',
    auto_compress_label: 'บีบอัดอัตโนมัติ',
    compress_failed_label: 'บีบอัดไม่สำเร็จ',
    focus_label: 'โฟกัส',
    token_usage_on: 'เปิดการแสดงโทเค็น',
    token_usage_off: 'ปิดการแสดงโทเค็น',
    usage_cache_hit_detail: 'แคช: โดน {0}% ({1} อ่าน / {2} เขียน)',
    usage_cached_percent: 'แคช {0}%',
    theme_usage: 'วิธีใช้: /theme ',
    theme_set: 'ธีม: ',
    no_active_session: 'ไม่มีเซสชันที่ใช้งาน',
    cmd_queue: 'คิวข้อความสำหรับเทิร์นถัดไป',
    cmd_goal: 'ตั้งหรือตรวจสอบเป้าหมายถาวร',
    goal_evaluating_progress: 'กำลังประเมินความคืบหน้าเป้าหมาย\u2026',
    goal_working_toward: 'กำลังทำงานไปสู่เป้าหมาย\u2026',
    goal_continuing_toast: 'กำลังดำเนินการต่อไปสู่เป้าหมาย\u2026',
    goal_status_none: 'ไม่มีเป้าหมายที่ใช้งาน ตั้งด้วย /goal <text>',
    goal_status_active: (turns, max_turns, goal) => `⊙ เป้าหมาย (ใช้งาน ${turns}/${max_turns} เทิร์น): ${goal}`,
    goal_status_paused: (turns, max_turns, reason, goal) => `⏸ เป้าหมาย (หยุดชั่วคราว ${turns}/${max_turns}${reason}): ${goal}`,
    goal_status_done: (turns, max_turns, goal) => `✓ เป้าหมายเสร็จ (${turns}/${max_turns}): ${goal}`,
    goal_set: (turns, goal) => `⊙ ตั้งเป้าหมายแล้ว (งบ ${turns} เทิร์น): ${goal}`,
    goal_paused: (goal) => `⏸ หยุดเป้าหมายชั่วคราว: ${goal}`,
    goal_resumed: (goal) => `▶ ดำเนินเป้าหมายต่อ: ${goal}`,
    goal_cleared: 'ล้างเป้าหมายแล้ว',
    goal_no_goal: 'ไม่มีเป้าหมายที่ใช้งาน',
    goal_achieved: (reason) => `✓ บรรลุเป้าหมาย: ${reason}`,
    goal_paused_budget_exhausted: (turns, max_turns) => `⏸ หยุดเป้าหมายชั่วคราว — ใช้ ${turns}/${max_turns} เทิร์นแล้ว ใช้ /goal resume เพื่อดำเนินต่อ`,
    goal_continuing: (turns, max_turns, reason) => `↻ ดำเนินต่อไปสู่เป้าหมาย (${turns}/${max_turns}): ${reason}`,
    cmd_interrupt: 'ยกเลิกเทิร์นปัจจุบันแล้วส่งข้อความใหม่',
    cmd_steer: 'ส่งคำแก้ไขระหว่างเทิร์นโดยไม่หยุด agent',
    cmd_queue_no_msg: 'วิธีใช้: /queue <message>',
    cmd_queue_not_busy: 'ไม่มีงานที่กำลังทำ — ส่งตามปกติได้',
    cmd_queue_confirm: 'คิวข้อความแล้ว',
    cmd_interrupt_no_msg: 'วิธีใช้: /interrupt <message>',
    cmd_interrupt_confirm: 'หยุดแล้ว — กำลังส่งข้อความใหม่',
    cmd_steer_no_msg: 'วิธีใช้: /steer <message>',
    cmd_steer_fallback: 'Steer ไม่พร้อม — คิวไว้สำหรับเทิร์นถัดไปแทน',
    cmd_steer_delivered: 'ส่ง steer แล้ว — agent จะเห็นเมื่อได้ผลลัพธ์เครื่องมือถัดไป',
    steer_leftover_queued: 'คิว steer ไว้สำหรับเทิร์นถัดไป',
    busy_steer_fallback: 'Steer ไม่พร้อม — คิวไว้สำหรับเทิร์นถัดไป',
    busy_interrupt_confirm: 'หยุดแล้ว — กำลังส่งข้อความใหม่',
    settings_label_busy_input_mode: 'โหมดป้อนข้อมูลขณะ agent ทำงาน',
    settings_desc_busy_input_mode: 'กำหนดว่าจะเกิดอะไรเมื่อส่งข้อความขณะ agent กำลังทำงาน คิว หยุด หรือ steer',
    settings_label_fade_text_effect: 'เอฟเฟกต์จางข้อความ',
    settings_desc_fade_text_effect: 'จางคำที่สตรีมใหม่เข้ามาขณะ assistant กำลังตอบ คล้าย ChatGPT',
    settings_busy_input_mode_queue: 'คิวข้อความถัดไป',
    settings_busy_input_mode_interrupt: 'หยุดเทิร์นปัจจุบัน',
    settings_busy_input_mode_steer: 'Steer (แก้ไขระหว่างเทิร์น)',

    slash_skill_badge: 'Skill',
    slash_skill_desc: 'เรียกใช้ skill นี้',
    cmd_stop: 'หยุดคำตอบปัจจุบัน',
    cmd_title: 'ดูหรือตั้งชื่อเซสชัน',
    cmd_retry: 'ส่งข้อความล่าสุดอีกครั้ง',
    cmd_undo: 'ลบการแลกเปลี่ยนล่าสุด',
    cmd_btw: 'ถามคำถามข้างเคียง (ไม่บันทึกในประวัติ)',
    cmd_btw_usage: '/btw <คำถาม> — ถามคำถามข้างเคียงโดยใช้บริบทเซสชัน',
    cmd_background: 'รัน prompt ในพื้นหลัง',
    cmd_background_usage: '/background <prompt> — รันคู่ขนานโดยไม่บล็อก',
    cmd_branch: 'แยกบทสนทนานี้เป็นเซสชันใหม่',
    cmd_branch_usage: '/branch [ชื่อ] — แยกบทสนทนา (ระบุชื่อได้)',
    branch_forked: 'แยกเป็นเซสชันใหม่แล้ว',
    branch_failed: 'แยกไม่สำเร็จ: ',
    fork_from_here: 'แยกจากจุดนี้',
    forked_from: 'แยกมาจาก',
    subagent_children: 'เซสชัน subagent',
    btw_asking: 'กำลังถามคำถามข้างเคียง...',
    btw_label: 'คำถามข้างเคียง — ไม่อยู่ในประวัติ',
    btw_done: 'ตอบคำถามข้างเคียงแล้ว',
    btw_no_answer: 'ไม่ได้รับคำตอบ',
    btw_failed: 'คำถามข้างเคียงล้มเหลว: ',
    bg_running: 'กำลังทำงานในพื้นหลัง...',
    bg_complete: 'งานพื้นหลังเสร็จแล้ว',
    bg_label: 'ผลลัพธ์พื้นหลัง:',
    bg_no_answer: '(ไม่มีคำตอบ)',
    bg_failed: 'งานพื้นหลังล้มเหลว: ',
    undo_exchange: 'ยกเลิกการแลกเปลี่ยนล่าสุด',
    cmd_status: 'แสดงข้อมูลเซสชัน',
    cmd_voice: 'สลับการป้อนเสียงจากไมโครโฟน',
    stream_stopped: 'หยุดคำตอบแล้ว',
    no_active_task: 'ไม่มีงานที่กำลังทำให้หยุด',
    cancel_unavailable: 'ยกเลิกไม่ได้',
    retry_failed: 'ลองใหม่ไม่สำเร็จ: ',
    undo_failed: 'ยกเลิกไม่สำเร็จ: ',
    undid_n_messages: 'ลบแล้ว',
    undid_messages_suffix: 'ข้อความ',
    status_heading: 'สถานะเซสชัน',
    status_session_id: 'รหัสเซสชัน',
    status_title: 'ชื่อ',
    status_model: 'โมเดล',
    status_provider: 'Provider',
    status_workspace: 'Workspace',
    status_personality: 'บุคลิก',
    status_messages: 'ข้อความ',
    status_agent_running: 'Agent กำลังทำงาน',
    status_profile: 'โปรไฟล์',
    status_hermes_home: 'Hermes home',
    status_started: 'เริ่ม',
    status_updated: 'อัปเดต',
    status_tokens: 'โทเค็น',
    status_ephemeral: 'สแnapshot ชั่วคราว — ไม่บันทึกในประวัติ transcript',
    status_no_tokens: 'ยังไม่ใช้โทเค็น',
    status_unknown: 'ไม่ทราบ',
    status_yes: 'ใช่',
    status_no: 'ไม่',
    status_load_failed: 'โหลดสถานะไม่สำเร็จ: ',
    title_current: 'ชื่อปัจจุบัน',
    title_change_hint: 'ใช้ `/title <ชื่อใหม่>` เพื่อเปลี่ยนชื่อ',
    title_set: 'ตั้งชื่อเป็น',
    cmd_webui_only_session: 'คำสั่งนี้ใช้ไม่ได้กับเซสชันที่นำเข้าจาก CLI',
    cmd_voice_use_mic: 'คลิกปุ่มไมโครโฟนในช่องพิมพ์',
    usage_heading: 'การใช้โทเค็น',
    usage_default_model: 'ค่าเริ่มต้น',
    usage_unknown: 'ไม่ทราบ',
    usage_input_tokens: 'โทเค็นขาเข้า',
    usage_output_tokens: 'โทเค็นขาออก',
    usage_total: 'โทเค็นรวม',
    usage_estimated_cost: 'ต้นทุนโดยประมาณ',
    usage_settings_tip: 'หมายเหตุ: การประมาณต้นทุนเป็นค่าโดยประมาณ',
    usage_load_failed: 'โหลดการใช้งานไม่สำเร็จ: ',
    usage_personality_none: 'ไม่มี',
    // Session toolsets (#493)
    session_toolsets: 'Session Toolsets',
    session_toolsets_desc: 'จำกัดเครื่องมือที่ใช้ได้ในเซสชันนี้ (ว่าง = ใช้การตั้งค่าระบบ)',
    session_toolsets_global: 'ระบบ (ค่าเริ่มต้น)',
    session_toolsets_custom: 'กำหนดเอง',
    session_toolsets_placeholder: 'tool1, tool2, \u2026',
    session_toolsets_apply: 'ใช้',
    session_toolsets_clear: 'ล้าง (ใช้ระบบ)',
    session_toolsets_applied: 'อัปเดต toolsets แล้ว',
    session_toolsets_cleared: 'ล้าง toolsets แล้ว — ใช้การตั้งค่าระบบ',
    session_toolsets_failed: 'อัปเดต toolsets ไม่สำเร็จ: ',
    no_personalities: 'ไม่พบบุคลิก (เพิ่มใน ~/.hermes/personalities/)',
    available_personalities: 'บุคลิกที่มี:',
    personality_switch_hint: '\\n\\nใช้ `/personality <name>` เพื่อสลับ หรือ `/personality none` เพื่อล้าง',
    personalities_load_failed: 'โหลดบุคลิกไม่สำเร็จ',
    personality_cleared: 'ล้างบุคลิกแล้ว',
    personality_set: 'บุคลิก: ',
    failed_colon: 'ไม่สำเร็จ: ',
    // ui.js
    no_workspace: 'ไม่มี workspace',
    terminal_open_title: 'เปิดเทอร์มินัล workspace',
    terminal_no_workspace_title: 'เลือก workspace เพื่อเปิดเทอร์มินัล',
    terminal_title: 'เทอร์มินัล',
    terminal_clear: 'ล้าง',
    terminal_copy_output: 'คัดลอกผลลัพธ์',
    terminal_restart: 'รีสตาร์ท',
    terminal_collapse: 'ย่อ',
    terminal_expand: 'ขยาย',
    terminal_close: 'ปิด',
    terminal_input_placeholder: 'รันคำสั่ง...',
    terminal_start_failed: 'เริ่มเทอร์มินัลไม่สำเร็จ: ',
    terminal_input_failed: 'ส่งคำสั่งเทอร์มินัลไม่สำเร็จ: ',
    terminal_copy_failed: 'คัดลอกไม่สำเร็จ: ',
    terminal_error: 'ข้อผิดพลาดเทอร์มินัล',
    workspace_empty_no_path: 'ยังไม่ได้เลือก workspace ตั้งค่าใน การตั้งค่า → Workspace เพื่อเรียกดูไฟล์',
    workspace_empty_dir: 'workspace นี้ว่างเปล่า',
    workspace_show_hidden_files: 'แสดงไฟล์ที่ซ่อน',
    workspace_show_hidden_files_desc: 'รวม .DS_Store, .git, node_modules และไฟล์ซ่อน/ระบบอื่นๆ ในไฟล์บราว์เซอร์',
    workspace_hidden_files_visible: 'แสดงไฟล์ซ่อน',
    workspace_hidden_files_visible_title: 'แสดงไฟล์ซ่อนอยู่ — คลิกเพื่อดูตัวเลือก',
    workspace_options: 'ตัวเลือก workspace',
    dialog_confirm_title: 'ยืนยันการกระทำ',
    dialog_prompt_title: 'ป้อนค่า',
    dialog_confirm_btn: 'ยืนยัน',
    // workspace.js
    unsaved_confirm: 'มีการแก้ไขที่ยังไม่ได้บันทึกในตัวอย่าง ทิ้งแล้วนำทางต่อหรือไม่?',
    discard: 'ทิ้ง',
    save: 'บันทึก',
    edit: 'แก้ไข',
    clear: 'ล้าง',
    ...
    edit_title: 'แก้ไขไฟล์นี้',
    saved: 'บันทึกแล้ว',
    save_failed: 'บันทึกไม่สำเร็จ: ',
    image_load_failed: 'โหลดรูปภาพไม่ได้',
    file_open_failed: 'เปิดไฟล์ไม่ได้',
    downloading: (name) => `กำลังดาวน์โหลด ${name}…`,
    double_click_rename: 'ดับเบิลคลิกเพื่อเปลี่ยนชื่อ',
    renamed_to: 'เปลี่ยนชื่อเป็น ',
    rename_failed: 'เปลี่ยนชื่อไม่สำเร็จ: ',
    delete_title: 'ลบ',
    delete_confirm: (name) => `ลบ ${name} หรือไม่?`,
    delete_dir_confirm: (name) => `ลบโฟลเดอร์ "${name}" และเนื้อหาทั้งหมดหรือไม่?`,
    rename_title: 'เปลี่ยนชื่อ',
    rename_prompt: 'ชื่อใหม่:',
    deleted: 'ลบแล้ว ',
    delete_failed: 'ลบไม่สำเร็จ: ',
    reveal_in_finder: 'เปิดใน File Manager',
    reveal_failed: 'เปิดไม่สำเร็จ: ',
    copy_file_path: 'คัดลอกพาธไฟล์',
    open_in_vscode: 'เปิดใน VS Code',
    open_in_vscode_failed: 'เปิดใน VS Code ไม่สำเร็จ: ',
    download_folder: 'ดาวน์โหลดโฟลเดอร์',
    path_copied: 'คัดลอกพาธไฟล์ไปยังคลิปบอร์ดแล้ว',
    path_copy_failed: 'คัดลอกพาธไม่สำเร็จ: ',
    session_rename: 'เปลี่ยนชื่อบทสนทนา',
    session_rename_desc: 'แก้ไขชื่อบทสนทนานี้',
    new_file_prompt: 'ชื่อไฟล์ใหม่ (เช่น notes.md):',
    project_name_prompt: 'ชื่อโปรเจกต์:',
    created: 'สร้างแล้ว ',
    create_failed: 'สร้างไม่สำเร็จ: ',
    new_folder_prompt: 'ชื่อโฟลเดอร์ใหม่:',
    folder_created: 'สร้างโฟลเดอร์แล้ว ',
    folder_create_failed: 'สร้างโฟลเดอร์ไม่สำเร็จ: ',
    workspace_auto_create_folder: 'สร้างโฟลเดอร์ถ้ายังไม่มี',
    folder_add_as_space_btn: 'เพิ่มเป็น Space',
    folder_add_as_space_msg: 'เพิ่มโฟลเดอร์นี้เป็น space ใหม่ในรายการ workspace หรือไม่?',
    folder_add_as_space_title: 'เพิ่มเป็น Space?',
    remove_title: 'ลบออก',
    empty_dir: '(ว่าง)',
    upload_failed: 'อัปโหลดไม่สำเร็จ: ',
    upload_too_large: (maxMb, fileMb) => `ไฟล์ใหญ่เกินไป (${fileMb} MB) ขนาดอัปโหลดสูงสุด ${maxMb} MB`,
    all_uploads_failed: (n) => `อัปโหลดทั้งหมด ${n} รายการล้มเหลว`,
    archive_extracted: (n, c) => `แตกไฟล์ ${n} รายการจาก ${c} ไฟล์บีบอัด`,
    session_pin: 'ปักหมุดบทสนทนา',
    session_unpin: 'เลิกปักหมุดบทสนทนา',
    session_pin_desc: 'เก็บบทสนทนานี้ไว้ด้านบน',
    session_unpin_desc: 'นำออกจากรายการปักหมุด',
    session_pin_failed: 'ปักหมุดไม่สำเร็จ: ',
    session_move_project: 'ย้ายไปโปรเจกต์',
    session_move_project_desc_has: 'เปลี่ยนโปรเจกต์ของบทสนทนานี้',
    session_move_project_desc_none: 'กำหนดโปรเจกต์ให้บทสนทนานี้',
    session_archive: 'เก็บถาวรบทสนทนา',
    session_hide_external: 'ซ่อนจากรายการ',
    session_restore: 'กู้คืนบทสนทนา',
    session_archive_desc: 'ซ่อนบทสนทนานี้จนกว่าจะแสดงรายการเก็บถาวร',
    session_archive_worktree_desc: 'ซ่อนบทสนทนานี้ แต่เก็บ worktree ไว้บนดิสก์',
    session_hide_external_desc: 'ซ่อนเซสชันที่นำเข้าจาก WebUI โดยไม่ลบประวัติต้นทาง',
    session_restore_desc: 'นำบทสนทนานี้กลับมาในรายการหลัก',
    session_archived: 'เก็บถาวรเซสชันแล้ว',
    session_archived_worktree: 'เก็บถาวรเซสชันแล้ว worktree ยังอยู่บนดิสก์',
    session_hidden: 'ซ่อนเซสชันจากรายการแล้ว',
    session_restored: 'กู้คืนเซสชันแล้ว',
    session_archive_failed: 'เก็บถาวรไม่สำเร็จ: ',
    session_duplicate: 'ทำสำเนาบทสนทนา',
    session_duplicate_desc: 'สร้างสำเนาที่มี workspace และโมเดลเดียวกัน',
    session_duplicated: 'ทำสำเนาเซสชันแล้ว',
    session_duplicate_failed: 'ทำสำเนาไม่สำเร็จ: ',
    session_stop_response: 'หยุดคำตอบ',
    session_stop_response_desc: 'ยกเลิกคำตอบที่กำลังทำงานของบทสนทนานี้',
    session_delete: 'ลบบทสนทนา',
    session_delete_desc: 'ลบบทสนทนานี้อย่างถาวร',
    session_delete_confirm: 'ลบบทสนทนานี้หรือไม่?',
    session_delete_worktree_desc: 'ลบเฉพาะบทสนทนา WebUI แต่เก็บ worktree ไว้บนดิสก์',
    session_delete_worktree_confirm: (path) => `ลบบทสนทนานี้หรือไม่? worktree ที่ ${path} จะยังอยู่บนดิสก์`,
    session_deleted: 'ลบบทสนทนาแล้ว',
    session_deleted_worktree: 'ลบบทสนทนาแล้ว worktree ยังอยู่บนดิสก์',
    session_worktree_remove: 'ลบ worktree',
    session_worktree_remove_desc: (path) => `ลบ git worktree ที่ ${path} จากดิสก์`,
    session_worktree_remove_confirm: (path) => `ลบ git worktree จากดิสก์หรือไม่?\n\nพาธ: ${path}\n\nการกระทำนี้จะลบ worktree และไฟล์ที่ยังไม่ commit`,
    session_worktree_remove_not_exists: (path) => `worktree ที่ ${path} ไม่มีอยู่บนดิสก์แล้ว`,
    session_worktree_remove_confirm_label: 'ลบออก',
    session_worktree_removed: 'ลบ worktree แล้ว',
    session_worktree_remove_failed: 'ลบ worktree ไม่สำเร็จ: ',
    session_worktree_remove_status_failed: 'อ่านสถานะ worktree ไม่สำเร็จ: ',
    session_worktree_remove_locked_by_stream: 'ลบไม่ได้ — มีเซสชันที่กำลังสตรีมใช้ worktree นี้อยู่',
    session_worktree_remove_locked_by_terminal: 'ลบไม่ได้ — มีเทอร์มินัลที่ใช้งานอยู่ใช้ worktree นี้',
    session_worktree_remove_unsafe_blocked: 'แก้ไขในเครื่องหรือ commit ที่ยังไม่ push ก่อนลบ worktree นี้',
    session_worktree_remove_dirty_warning: 'คำเตือน: worktree นี้มีการเปลี่ยนแปลงที่ยังไม่ commit ซึ่งจะสูญหาย',
    session_worktree_remove_untracked_warning: (count) => `ไฟล์ที่ยังไม่ track ${count} รายการจะถูกลบถาวร`,
    session_worktree_remove_ahead_warning: (ahead) => `commit ที่ยังไม่ push ${ahead} รายการจะสูญหาย`,
    session_select_mode: 'เลือก',
    session_select_mode_desc: 'เลือกบทสนทนาเพื่อจัดการเป็นชุด',
    session_select_all: 'เลือกทั้งหมด',
    session_deselect_all: 'ยกเลิกการเลือกทั้งหมด',
    session_selected_count: 'เลือก {0} รายการ',
    session_batch_archive: 'เก็บถาวร',
    session_batch_delete: 'ลบ',
    session_batch_move: 'ย้ายไปโปรเจกต์',
    session_batch_delete_confirm: 'ลบ {0} บทสนทนาหรือไม่?',
    session_batch_archive_confirm: 'เก็บถาวร {0} บทสนทนาหรือไม่?',
    session_batch_delete_worktree_confirm: 'ลบ {0} บทสนทนาหรือไม่? {1} บทสนทนาที่มี worktree จะยังคง worktree ไว้บนดิสก์',
    session_batch_archive_worktree_confirm: 'เก็บถาวร {0} บทสนทนาหรือไม่? {1} บทสนทนาที่มี worktree จะเก็บ worktree ไว้บนดิสก์',
    session_no_selection: 'ยังไม่ได้เลือกบทสนทนา',
    // settings panel
    settings_heading_title: 'ศูนย์ควบคุม',
    settings_heading_subtitle: 'การตั้งค่า เครื่องมือบทสนทนา และการควบคุมระบบ',
    settings_section_conversation_title: 'บทสนทนา',
    settings_section_appearance_title: 'รูปลักษณ์',
    settings_section_appearance_meta: 'ธีม สีเน้น และสไตล์ภาพ',
    settings_section_preferences_title: 'การตั้งค่า',
    settings_section_preferences_meta: 'ค่าเริ่มต้นและพฤติกรรม UI ของ Hermes Web UI',
    settings_section_system_title: 'ระบบ',
    settings_section_system_meta: 'เวอร์ชันอินสแตนซ์และการควบคุมการเข้าถึง',
    settings_check_now: 'ตรวจสอบตอนนี้',
    settings_checking: 'กำลังตรวจสอบ\u2026',
    settings_up_to_date: 'เป็นเวอร์ชันล่าสุด ✓',
    settings_updates_available: 'มีอัปเดต {count} รายการ',
    settings_updates_disabled: 'ปิดการตรวจสอบอัปเดต',
    settings_update_check_failed: 'ตรวจสอบอัปเดตไม่สำเร็จ',
    settings_label_workspace_panel_open: 'เปิดแผง workspace เป็นค่าเริ่มต้น',
    settings_desc_workspace_panel_open: 'เมื่อเปิดใช้ แผง workspace/ไฟล์บราว์เซอร์จะเปิดอัตโนมัติในแต่ละบทสนทนา',
    settings_label_session_jump_buttons: 'แสดงปุ่มกระโดดในเซสชัน',
    settings_desc_session_jump_buttons: 'แสดงปุ่มลอย Start และ End ขณะอ่านประวัติเซสชันที่ยาว',

    settings_label_session_endless_scroll: 'โหลดข้อความเก่าเมื่อเลื่อนขึ้น',

    settings_desc_session_endless_scroll: 'เมื่อเปิด ข้อความเก่าจะโหลดอัตโนมัติเมื่อเลื่อนขึ้น เมื่อปิด ต้องคลิกเพื่อโหลด',

    settings_label_tab_visibility: 'แท็บแถบด้านข้าง',
    settings_desc_tab_visibility: 'เลือกแท็บที่แสดงในแถบด้านข้าง Chat และ Settings แสดงเสมอ',
    open_in_browser: 'เปิดในเบราว์เซอร์',
    settings_dropdown_conversation: 'บทสนทนา',
    settings_dropdown_appearance: 'รูปลักษณ์',
    settings_dropdown_preferences: 'การตั้งค่า',
    settings_dropdown_providers: 'Providers',
    settings_dropdown_system: 'ระบบ',
    settings_tab_conversation: 'บทสนทนา',
    settings_tab_appearance: 'รูปลักษณ์',
    settings_tab_preferences: 'การตั้งค่า',
    settings_tab_plugins: 'ปลั๊กอิน',
    settings_plugins_title: 'ปลั๊กอิน',
    settings_plugins_meta: 'ดูปลั๊กอิน Hermes ที่ติดตั้งและ lifecycle hooks ที่ลงทะเบียน แผงนี้เป็นแบบอ่านอย่างเดียว',
    settings_plugins_empty: 'ไม่พบปลั๊กอิน Hermes ติดตั้งจาก Hermes CLI หรือเปิดใช้งานใน config',
    plugins_unnamed: 'ปลั๊กอินไม่มีชื่อ',
    plugins_no_description: 'ไม่มีคำอธิบาย',
    plugins_no_hooks: 'ไม่มี lifecycle hooks ที่ลงทะเบียน',
    plugins_registered_hooks: 'Hooks ที่ลงทะเบียน',
    plugins_enabled: 'เปิดใช้งาน',
    plugins_disabled: 'ปิดใช้งาน',
    plugins_active_provider: 'ใช้งาน (provider)',
    plugins_provider_no_hooks: 'ปลั๊กอิน provider — ไม่มี hooks ที่ agent เห็น',
    plugins_load_failed: 'โหลดปลั๊กอินไม่สำเร็จ: ',
    settings_tab_system: 'ระบบ',
    settings_title: 'การตั้งค่า',
    settings_save_btn: 'บันทึกการตั้งค่า',
    settings_label_model: 'โมเดลเริ่มต้น',
    settings_desc_model: 'ใช้กับบทสนทนาใหม่ บทสนทนาเดิมยังใช้โมเดลที่เลือกไว้',
    settings_label_auxiliary_models: 'โมเดลเสริม',
    settings_desc_auxiliary_models: 'กำหนดเส้นทางงานย่อย เช่น vision บีบอัด สร้างชื่อ ฯลฯ "Auto" ใช้โมเดลหลัก',
    settings_btn_reset_aux_models: 'รีเซ็ตทั้งหมดเป็น auto',
    settings_btn_apply_aux_models: 'ใช้การเปลี่ยนแปลง',
    settings_aux_provider_auto: 'ใช้โมเดลหลัก',
    settings_aux_model_auto: 'auto (ใช้ค่าเริ่มต้นของ provider)',
    settings_aux_model_custom: 'โมเดลกำหนดเอง\u2026',
    settings_aux_model_custom_prompt: 'ป้อนรหัสโมเดล:',
    settings_aux_loading: 'กำลังโหลดโมเดลเสริม\u2026',
    settings_aux_load_failed: 'โหลดการตั้งค่าโมเดลเสริมไม่ได้ ตรวจสอบว่า agent API พร้อมใช้งาน',
    settings_aux_reset_confirm_title: 'รีเซ็ตโมเดลเสริมหรือไม่?',
    settings_aux_reset_confirm_msg: 'จะตั้งงานเสริมทั้งหมดเป็น auto (ใช้โมเดลหลัก)',
    settings_aux_reset_done: 'รีเซ็ตโมเดลเสริมเป็น auto แล้ว',
    settings_aux_save_failed: 'บันทึกโมเดลเสริมไม่สำเร็จ',
    settings_aux_saved: 'อัปเดตโมเดลเสริมแล้ว',
    settings_aux_no_changes: 'ไม่มีการเปลี่ยนแปลงให้ใช้',
    settings_label_send_key: 'ปุ่มส่ง',
    settings_label_theme: 'ธีม',
    settings_label_skin: 'Skin',
    settings_label_font_size: 'ขนาดตัวอักษร',
    font_size_small: 'เล็ก',
    font_size_default: 'ปกติ',
    font_size_large: 'ใหญ่',
    font_size_xlarge: 'ใหญ่มาก',
    settings_autosave_saving: 'กำลังบันทึก\u2026',
    settings_autosave_saved: 'บันทึกแล้ว',
    settings_autosave_failed: 'บันทึกไม่สำเร็จ',
    settings_autosave_retry: 'ลองใหม่',
    settings_label_language: 'ภาษา',
    settings_label_quota_chip: 'แสดงชิปโควตา provider ในช่องพิมพ์',
    settings_desc_quota_chip: 'แสดงโควตาที่เหลือ (เช่น ยอดเครดิต OpenRouter) ในช่องพิมพ์',
    settings_label_hide_suggestions: 'ซ่อนคำแนะนำแชทใหม่',
    settings_desc_hide_suggestions: 'ซ่อนปุ่มคำแนะนำ 3 ปุ่มบนหน้าแชทว่าง',
    settings_label_token_usage: 'แสดงการใช้โทเค็น',
    settings_label_sidebar_density: 'ความหนาแน่นแถบด้านข้าง',
    cmd_reasoning: 'สลับการแสดงการคิด ตั้งระดับ effort หรือดูสถานะปัจจุบัน',
    settings_label_external_sessions: 'แสดงเซสชันนอก WebUI',
    settings_label_previous_messaging_sessions: 'แสดงเซสชัน messaging เก่า',
    settings_label_sync_insights: 'ซิงค์ไป insights',
    settings_label_check_updates: 'ตรวจสอบอัปเดต',
    settings_label_ignore_agent_updates: 'ไม่สนใจอัปเดต Agent',
    settings_label_whats_new_summary: 'สรุป What\'s New ด้วย AI',
    settings_label_bot_name: 'ชื่อ assistant เริ่มต้น',
    settings_label_password: 'รหัสผ่านการเข้าถึง',
    settings_saved: 'บันทึกการตั้งค่าแล้ว',
    settings_save_failed: 'บันทึกไม่สำเร็จ: ',
    settings_load_failed: 'โหลดการตั้งค่าไม่สำเร็จ: ',
    settings_saved_pw: 'บันทึกการตั้งค่าแล้ว — เปิดใช้รหัสผ่านและเบราว์เซอร์นี้ยังลงชื่ออยู่',
    settings_saved_pw_updated: 'บันทึกการตั้งค่าแล้ว — อัปเดตรหัสผ่านแล้ว',
    // login page (used server-side via /api/i18n/login endpoint)
    login_title: 'เข้าสู่ระบบ',
    login_subtitle: 'ป้อนรหัสผ่านเพื่อดำเนินการต่อ',
    login_placeholder: 'รหัสผ่าน',
    login_btn: 'เข้าสู่ระบบ',
    login_invalid_pw: 'รหัสผ่านไม่ถูกต้อง',
    login_conn_failed: 'เชื่อมต่อไม่สำเร็จ',
    // Sidebar & Tabs
    tab_chat: 'แชท',
    tab_tasks: 'งาน',
    tab_skills: 'Skills',
    tab_memory: 'หน่วยความจำ',
    tab_workspaces: 'Spaces',
    ...
    kanban_board: 'บอร์ด',
    kanban_visible_tasks: 'งานที่แสดง {0} รายการ',
    kanban_search_tasks: 'ค้นหางาน',
    kanban_all_assignees: 'ผู้รับผิดชอบทั้งหมด',
    kanban_all_tenants: 'Tenant ทั้งหมด',
    kanban_include_archived: 'รวมที่เก็บถาวร',
    kanban_no_matching_tasks: 'ไม่พบงานที่ตรงกัน',
    kanban_no_data: 'ไม่มีข้อมูล Kanban',
    kanban_work_queue_hint: 'นี่คือคิวงาน Hermes Agent สร้างหรือจัดลำดับงาน มอบหมาย แล้วย้ายไป Ready เพื่อให้ dispatcher หยิบไปทำ',
    kanban_unavailable: 'Kanban ไม่พร้อมใช้งาน',
    kanban_read_only: 'มุมมองอ่านอย่างเดียว',
    kanban_empty: 'ว่าง',
    kanban_task: 'งาน',
    kanban_no_description: 'ไม่มีคำอธิบาย',
    kanban_refresh: 'รีเฟรช',
    kanban_status_triage: 'Triage',
    kanban_status_todo: 'Todo',
    kanban_status_ready: 'Ready',
    kanban_status_running: 'Running',
    kanban_status_blocked: 'Blocked',
    kanban_status_done: 'Done',
    kanban_comments_count: 'ความคิดเห็น ({0})',
    kanban_events_count: 'เหตุการณ์ ({0})',
    kanban_links: 'ลิงก์',
    kanban_parents: 'งานแม่',
    kanban_children: 'งานลูก',
    kanban_runs_count: 'รัน ({0})',
    kanban_no_comments: 'ไม่มีความคิดเห็น',
    kanban_no_events: 'ไม่มีเหตุการณ์',
    kanban_no_runs: 'ไม่มีรัน',
    kanban_title: 'ชื่อ',
    kanban_description: 'คำอธิบาย',
    kanban_description_placeholder: 'ไม่บังคับ — สิ่งที่ต้องทำ เกณฑ์ยอมรับ ลิงก์',
    kanban_status: 'สถานะ',
    kanban_assignee: 'ผู้รับผิดชอบ',
    kanban_assignee_placeholder: 'ไม่บังคับ — ว่างไว้สำหรับ worker ใดก็ได้',
    kanban_tenant: 'Tenant',
    kanban_tenant_placeholder: 'ไม่บังคับ — slug โปรเจกต์หรือทีม',
    kanban_priority: 'ลำดับความสำคัญ',
    kanban_priority_low: 'ต่ำ',
    kanban_priority_normal: 'ปกติ',
    kanban_priority_high: 'สูง',
    kanban_priority_urgent: 'ด่วน',
    kanban_priority_hint: 'งานที่สำคัญกว่าจะถูกรันก่อน ค่าเริ่มต้นคือปกติ',
    kanban_title_required: 'ต้องระบุชื่อ',
    kanban_new_task: 'งานใหม่',
    kanban_edit_task: 'แก้ไขงาน',
    kanban_status_original_hint: 'สถานะจริง: {0} กล่องโต้ตอบนี้รองรับแก้ไข Triage/Todo/Ready เท่านั้น',
    kanban_run_dispatcher: 'รัน dispatcher',
    kanban_run_dispatcher_confirm: 'จะ claim งาน Ready บนบอร์ดนี้และ spawn worker subprocess (หนึ่งต่องาน)',
    kanban_assignee_profiles_label: 'โปรไฟล์ Hermes',
    kanban_assignee_other_label: 'อื่นๆ (CLI lanes / โปรไฟล์ที่ถูกลบ)',
    kanban_assignee_unassigned: '— ยังไม่มอบหมาย (จะไม่รันอัตโนมัติ) —',
    kanban_ready_needs_assignee: 'เลือก Unassigned + Ready dispatcher จะข้ามงานนี้ ส่งอีกครั้งหลังมอบหมาย',
    kanban_dispatch_preview_prefix: 'ตัวอย่าง:',
    kanban_dispatch_run_prefix: 'ส่งแล้ว:',
    kanban_dispatch_spawned: 'spawn แล้ว',
    kanban_dispatch_promoted: 'เลื่อนสถานะแล้ว',
    kanban_dispatch_reclaimed: 'reclaim แล้ว',
    kanban_dispatch_skipped_unassigned: 'ข้าม (ไม่มีผู้รับผิดชอบ)',
    kanban_dispatch_skipped_nonspawnable: 'ข้าม (ไม่รู้จักโปรไฟล์)',
    kanban_dispatch_auto_blocked: 'บล็อกอัตโนมัติ',
    kanban_dispatch_timed_out: 'หมดเวลา',
    kanban_dispatch_crashed: 'crash',
    kanban_add_comment: 'เพิ่มความคิดเห็น',
    kanban_only_mine: 'ของฉันเท่านั้น',
    kanban_bulk_action: 'การกระทำเป็นชุด',
    kanban_nudge_dispatcher: 'ดูตัวอย่าง dispatcher',
    kanban_stats: 'สถิติ',
    kanban_worker_log: 'Worker log',
    kanban_block: 'บล็อก',
    kanban_unblock: 'ปลดบล็อก',
    kanban_back_to_board: 'กลับไปบอร์ด',
    kanban_lanes_by_profile: 'เลนแยกตามโปรไฟล์',
    kanban_new_board: 'บอร์ดใหม่…',
    kanban_rename_board: 'เปลี่ยนชื่อบอร์ดปัจจุบัน…',
    kanban_archive_board: 'เก็บถาวรบอร์ดปัจจุบัน…',
    kanban_archive_board_confirm: 'เก็บถาวรบอร์ด "{name}" หรือไม่? งานยังอยู่บนดิสก์และกู้คืนได้จาก kanban/boards/_archived/',
    kanban_board_archived: 'เก็บถาวรบอร์ดแล้ว',
    kanban_board_name: 'ชื่อ',
    kanban_board_slug: 'Slug (ตัวพิมพ์เล็ก ใช้ขีด)',
    kanban_board_description: 'คำอธิบาย (ไม่บังคับ)',
    kanban_board_icon: 'ไอคอน (emoji ไม่บังคับ)',
    kanban_board_color: 'สี (ไม่บังคับ)',
    kanban_board_name_required: 'ต้องระบุชื่อ',
    kanban_board_slug_required: 'ต้องระบุ slug',
    kanban_card_complete: 'เสร็จ',
    kanban_card_archive: 'เก็บถาวร',
    kanban_unassigned: 'ยังไม่มอบหมาย',
    kanban_status_archived: 'เก็บถาวร',
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: 'Hermes Dashboard',
    dashboard_loopback_warning: 'Dashboard ใช้ได้เฉพาะ loopback บนเซิร์ฟเวอร์ เปิดจากเครื่องเซิร์ฟเวอร์หรือตั้งค่า proxy/tunnel',
    tab_logs: 'Logs',
    tab_settings: 'การตั้งค่า',
    new_conversation: 'บทสนทนาใหม่',
    filter_conversations: 'กรองบทสนทนา...',
    session_time_unknown: 'ไม่ทราบ',
    session_time_minutes_ago: (n) => `${n} น.`,
    session_time_hours_ago: (n) => `${n} ชม.`,
    session_time_days_ago: (n) => `${n} ว.`,
    session_time_last_week: '1 ส.',
    session_time_bucket_today: 'วันนี้',
    session_time_bucket_yesterday: 'เมื่อวาน',
    session_time_bucket_this_week: 'สัปดาห์นี้',
    session_time_bucket_last_week: 'สัปดาห์ที่แล้ว',
    session_time_bucket_older: 'เก่ากว่า',
    scheduled_jobs: 'งานที่กำหนดเวลา',
    new_job: 'งานใหม่',
    loading: 'กำลังโหลด...',
    search_skills: 'ค้นหา skills...',
    new_skill: 'Skill ใหม่',
    personal_memory: 'หน่วยความจำส่วนตัว',
    current_task_list: 'รายการงานปัจจุบัน',
    // Logs
    logs_title: 'Logs',
    logs_file: 'ไฟล์',
    logs_tail: 'ท้ายไฟล์',
    logs_auto_refresh: 'รีเฟรชอัตโนมัติ (5 วิ)',
    logs_wrap: 'ขึ้นบรรทัดใหม่',
    logs_copy_all: 'คัดลอกทั้งหมด',
    logs_empty: 'ยังไม่มีบรรทัด log',
    logs_loading: 'กำลังโหลด logs\u2026',
    logs_load_failed: 'โหลด logs ไม่สำเร็จ',
    logs_status_idle: 'เลือกไฟล์ log เพื่อดูบรรทัดล่าสุด',
    logs_no_mtime: 'ยังไม่ได้เขียน',
    logs_truncated_hint: 'แสดงท้ายไฟล์ log ขนาดใหญ่ ข้ามไบต์เก่าเพื่อประหยัดหน่วยความจำ',
    logs_copied: 'คัดลอก logs แล้ว',
    logs_severity: 'ระดับความรุนแรง',
    logs_severity_all: 'ทั้งหมด',
    logs_severity_errors: 'ข้อผิดพลาด',
    logs_severity_warnings: 'คำเตือนขึ้นไป',
    logs_filter_active: 'แสดง (มีตัวกรอง)',

    // Insights
    insights_title: 'การวิเคราะห์การใช้งาน',
    insights_sessions: 'เซสชัน',
    insights_messages: 'ข้อความ',
    insights_tokens: 'โทเค็น',
    insights_cost: 'ต้นทุนโดยประมาณ',
    insights_no_cost: 'N/A',
    insights_models: 'โมเดล',
    insights_activity_by_day: 'กิจกรรมตามวัน',
    insights_activity_by_hour: 'กิจกรรมตามชั่วโมง',
    insights_peak_hour: 'สูงสุด: {hour}',
    insights_token_breakdown: 'รายละเอียดโทเค็น',
    insights_input_tokens: 'Input',
    insights_output_tokens: 'Output',
    insights_total: 'รวม',
    insights_daily_tokens: 'โทเค็นรายวัน',
    insights_model_name: 'โมเดล',
    insights_model_sessions: 'เซสชัน',
    insights_model_tokens: 'โทเค็น',
    insights_model_cost: 'ต้นทุน',
    insights_model_share: 'สัดส่วน',
    insights_no_usage_data: 'ยังไม่มีข้อมูลการใช้งาน',
    insights_footer: 'แสดงข้อมูล {days} วันที่ผ่านมา',
    workspace_desc: 'แต่ละโปรไฟล์มี workspace หนึ่ง สร้างอัตโนมัติ',
    session_meta_messages: (n) => `${n} ข้อความ`,
    session_meta_children: (n) => `${n} ลูก`,
    // Softened label: avoids exposing the technical internal term
    // 'segment' in the default visible badge. User-facing copy remains
    // translatable for locales that prefer a different wording. (#2155)
    session_meta_segments: (n) => `${n} เทิร์นก่อนหน้า`,
    session_lineage_segment_untitled: 'ส่วนไม่มีชื่อ',
    session_lineage_segment_open: 'เปิดส่วน lineage',
    new_profile: 'โปรไฟล์ใหม่',
    transcript: 'Transcript',
    download_transcript: 'ดาวน์โหลดเป็น Markdown',
    import: 'นำเข้า',
    export_session_json: 'JSON',
    export_session_json_tooltip: 'ส่งออกเซสชันเต็มเป็น JSON',
    import_session_json_tooltip: 'นำเข้าเซสชันจาก JSON',
    clear_conversation_btn_tooltip: 'ล้างข้อความทั้งหมดในบทสนทนานี้',
    // Settings detail
    settings_label_rtl: 'เลย์เอาต์แชทขวาไปซ้าย',
    settings_desc_rtl: 'สลับการจัดแนวข้อความและช่องพิมพ์สำหรับภาษา RTL',
    settings_label_sound: 'เสียงแจ้งเตือน',
    settings_desc_sound: 'เล่นเสียงเมื่อ assistant ตอบเสร็จ',
    // TTS (#499)
    tts_listen: 'ฟัง',
    tts_not_supported: 'ไม่รองรับการสังเคราะห์เสียงในเบราว์เซอร์นี้',
    settings_label_tts: 'Text-to-Speech สำหรับคำตอบ',
    settings_desc_tts: 'แสดงปุ่มลำโพงบนข้อความ assistant เพื่ออ่านออกเสียง',
    settings_label_tts_auto_read: 'อ่านคำตอบออกเสียงอัตโนมัติ',
    settings_desc_tts_auto_read: 'พูดคำตอบ assistant ใหม่เมื่อเสร็จ หยุดเมื่อคุณพิมพ์',
    // Composer voice-mode pref (#1488)
    settings_label_voice_mode: 'ปุ่มโหมดเสียงแบบ hands-free',
    settings_desc_voice_mode: 'แสดงปุ่มโหมดเสียง (waveform) ข้างไมโครโฟน dictation',
    settings_label_tts_voice: 'เสียง',
    settings_desc_tts_voice: 'เสียงที่ต้องการ ดึงจากเสียงที่เบราว์เซอร์มี',
    settings_label_tts_rate: 'ความเร็วการพูด',
    settings_label_tts_pitch: 'ระดับเสียง',
    settings_label_notifications: 'การแจ้งเตือนของเบราว์เซอร์',
    ...
    settings_label_api_redact: 'ปิดบังข้อมูลละเอียดอ่อนใน API responses',
    settings_desc_api_redact: 'ผู้ใช้ self-hosted ปิดได้เพื่อความโปร่งใส (ไม่แนะนำสำหรับอินสแตนซ์ที่แชร์)',
    settings_sidebar_density_compact: 'กระชับ',
    settings_sidebar_density_detailed: 'ละเอียด',
    settings_desc_sidebar_density: 'ควบคุม metadata ที่รายการเซสชันในแถบด้านข้างแสดง',
    settings_label_auto_title_refresh: 'รีเฟรชชื่ออัตโนมัติ',
    settings_auto_title_refresh_off: 'ปิด',
    settings_auto_title_refresh_5: 'ทุก 5 รอบ',
    settings_auto_title_refresh_10: 'ทุก 10 รอบ',
    settings_auto_title_refresh_20: 'ทุก 20 รอบ',
    ...
    settings_desc_previous_messaging_sessions: 'แสดงเซสชัน Discord, Telegram, Slack, Weixin เก่าที่ถูกแทนที่',
    ...
    settings_desc_ignore_agent_updates: 'ยังตรวจ WebUI แต่ซ่อนแจ้งเตือน Agent และข้ามการอัปเดต Agent',
    settings_desc_whats_new_summary: 'เปลี่ยน What\'s New จาก diff ดิบเป็นการสรุปสั้นๆ ด้วย AI',
    ...
    password_placeholder: 'ป้อนรหัสผ่านใหม่\u2026',
    password_env_var_locked: 'ตั้ง HERMES_WEBUI_PASSWORD ใน environment แล้วและมีลำดับสูงกว่าการตั้งค่า UI',
    password_env_var_locked_placeholder: 'ล็อก: ตั้ง HERMES_WEBUI_PASSWORD ใน env แล้ว',
    disable_auth: 'ปิด Auth',
    sign_out: 'ออกจากระบบ',
    settings_label_shutdown: 'หยุดเซิร์ฟเวอร์ Hermes WebUI',
    settings_desc_shutdown: 'หยุดเซิร์ฟเวอร์ WebUI อย่างสง่างาม มีประโยชน์เมื่อเปิดด้วย <code>./ctl start</code>',
    settings_btn_shutdown: 'หยุดเซิร์ฟเวอร์',
    settings_shutdown_confirm_title: 'หยุด Hermes WebUI',
    settings_shutdown_confirm_message: 'หยุดเซิร์ฟเวอร์ Hermes WebUI หรือไม่?',
    settings_shutdown_confirm_btn: 'หยุด',
    settings_shutdown_stopped_message: 'หยุดเซิร์ฟเวอร์แล้ว ปิดแท็บนี้ได้',
    // Providers panel
    providers_tab_title: 'Providers',
    providers_section_title: 'Providers',
    providers_section_meta: 'จัดการ API keys ของ AI providers มีผลทันที',
    providers_status_configured: 'ตั้งค่า API key แล้ว',
    providers_status_not_configured: 'ไม่มี API key',
    providers_status_oauth: 'OAuth',
    providers_status_api_key: 'API key',
    providers_status_not_configured_label: 'ยังไม่ตั้งค่า',
    providers_oauth_hint: 'ยืนยันตัวตนด้วย OAuth ไม่ต้องใช้ API key',
    providers_oauth_config_yaml_hint: 'ตั้ง token ผ่าน config.yaml อัปเดตใน providers section ของ config',
    providers_oauth_not_configured_hint: 'ยังไม่ยืนยันตัวตน รัน hermes auth ในเทอร์มินัลเพื่อตั้งค่า provider นี้',
    providers_save: 'บันทึก',
    providers_remove: 'ลบ',
    providers_saving: 'กำลังบันทึก\u2026',
    providers_removing: 'กำลังลบ\u2026',
    providers_enter_key: 'กรุณาป้อน API key',
    providers_empty: 'ไม่พบ provider ที่ตั้งค่าได้',
    providers_key_updated: 'บันทึก API key แล้ว',
    providers_key_removed: 'ลบ API key แล้ว',
    providers_key_placeholder_new: 'sk-...',
    providers_key_placeholder_replace: 'ป้อน key ใหม่เพื่อแทนที่\u2026',
    provider_quota_title: 'โควตา provider ที่ใช้งาน',
    provider_quota_active_provider: 'Provider ที่ใช้งาน',
    provider_quota_last_checked_after_refresh: 'ตรวจล่าสุดหลังรีเฟรช',
    provider_quota_last_checked: 'ตรวจล่าสุด {0}',
    provider_quota_refresh_usage: 'รีเฟรชการใช้งาน',
    provider_quota_refreshing: 'กำลังรีเฟรช...',
    provider_quota_refresh_title: 'รีเฟรชขีดจำกัดการใช้งาน provider ตอนนี้',
    provider_quota_refresh_succeeded: 'รีเฟรชการใช้งาน provider แล้ว',
    provider_quota_refresh_failed: 'รีเฟรชการใช้งาน provider ไม่สำเร็จ',
    provider_quota_session_limit: 'ขีดจำกัด 5 ชม.',
    provider_quota_weekly_limit: 'ขีดจำกัดรายสัปดาห์',
    provider_quota_window_fallback: 'ช่วงเวลา',
    provider_quota_metric_remaining: 'เหลือ',
    provider_quota_metric_used: 'ใช้แล้ว',
    provider_quota_metric_limit: 'ขีดจำกัด',
    provider_quota_status_available: 'พร้อมใช้',
    provider_quota_status_exhausted: 'หมด',
    provider_quota_status_unavailable: 'ไม่พร้อม',
    provider_quota_status_failed: 'ล้มเหลว',
    provider_quota_status_checked: 'ตรวจแล้ว',
    provider_quota_status_no_key: 'ไม่มี key',
    provider_quota_status_invalid_key: 'key ไม่ถูกต้อง',
    provider_quota_status_unsupported: 'ไม่รองรับ',
    provider_quota_used_meta: 'ใช้ {0}',
    provider_quota_resets_meta: 'รีเซ็ต {0}',
    provider_quota_credential_pool: 'Credential pool',
    provider_quota_credential_label: 'Credential {0}',
    provider_quota_pool_plans: 'แผน: {0}',
    provider_quota_pool_no_windows: 'ไม่มีหน้าต่างขีดจำกัดบัญชี',
    provider_quota_account_limits_loaded: 'โหลดขีดจำกัดบัญชีแล้ว',
    provider_quota_unavailable: 'สถานะโควตาไม่พร้อม',
    provider_quota_retry_after: 'ลองใหม่หลัง {0}',
    provider_quota_pool_summary_available: '{0}/{1} พร้อมใช้',
    provider_quota_pool_summary_exhausted: '{0} หมด',
    provider_quota_pool_summary_failed: '{0} ล้มเหลว',
    provider_quota_pool_summary_checked: '{0} ตรวจแล้ว',
    cancel: 'ยกเลิก',
    create_job: 'สร้างงาน',
    save_skill: 'บันทึก skill',
    editing: 'กำลังแก้ไข',
    // Empty state
    empty_title: 'ให้ช่วยอะไรได้บ้าง?',
    empty_subtitle: 'ถามอะไรก็ได้ รันคำสั่ง สำรวจไฟล์ หรือจัดการงานที่กำหนดเวลา',
    suggest_files: 'มีไฟล์อะไรใน workspace นี้บ้าง?',
    suggest_schedule: 'วันนี้มีอะไรในตารางบ้าง?',
    suggest_plan: 'ช่วยวางแผนโปรเจกต์เล็กๆ หน่อย',
    // onboarding
    onboarding_badge: 'ครั้งแรก',
    onboarding_title: 'ยินดีต้อนรับสู่ Hermes Web UI',
    onboarding_lead: 'การตั้งค่าแนะนำสั้นๆ จะตรวจสอบ Hermes บันทึกการตั้งค่า provider จริง เลือก workspace และโมเดล',
    onboarding_back: 'ย้อนกลับ',
    onboarding_continue: 'ดำเนินการต่อ',
    onboarding_skip: 'ข้ามการตั้งค่า',
    onboarding_skipped: 'ข้ามการตั้งค่า — ใช้ config เดิม',
    onboarding_open: 'เปิด Hermes',
    onboarding_step_system_title: 'ตรวจสอบระบบ',
    onboarding_step_system_desc: 'ตรวจสอบ Hermes Agent และการมองเห็น config',
    onboarding_step_setup_title: 'ตั้งค่า provider',
    onboarding_step_setup_desc: 'บันทึก config provider ขั้นต่ำของ Hermes',
    onboarding_step_workspace_title: 'Workspace + โมเดล',
    onboarding_step_workspace_desc: 'เลือกค่าเริ่มต้นสำหรับเซสชันและแชทใหม่',
    onboarding_step_password_title: 'รหัสผ่าน (ไม่บังคับ)',
    onboarding_step_password_desc: 'ป้องกัน Web UI ก่อนแชร์',
    onboarding_step_finish_title: 'เสร็จสิ้น',
    onboarding_step_finish_desc: 'ตรวจสอบแล้วเข้าแอป',
    onboarding_notice_system_ready: 'Hermes Agent พร้อมใช้งานจาก Web UI',
    onboarding_notice_system_unavailable: 'Hermes Agent ยังไม่พร้อม Bootstrap ติดตั้งได้ แต่ provider อาจยังไม่พร้อม',
    onboarding_check_agent: 'Hermes Agent',
    onboarding_check_agent_ready: 'ตรวจพบและ import ได้',
    onboarding_check_agent_missing: 'ขาดหายหรือ import ได้บางส่วน',
    onboarding_check_password: 'รหัสผ่าน',
    onboarding_check_password_enabled: 'เปิดใช้แล้ว',
    onboarding_check_password_disabled: 'ยังไม่เปิด',
    onboarding_check_provider: 'การตั้งค่า provider',
    onboarding_check_provider_ready: 'พร้อมแชท',
    onboarding_check_provider_partial: 'บันทึกแล้วแต่ยังไม่ครบ',
    onboarding_check_provider_pending: 'ต้องตรวจสอบ',
    onboarding_config_file: 'ไฟล์ config:',
    onboarding_env_file: 'ไฟล์ .env:',
    onboarding_unknown: 'ไม่ทราบ',
    onboarding_current_provider: 'การตั้งค่าปัจจุบัน:',
    onboarding_missing_imports: 'import ที่ขาด:',
    onboarding_notice_setup_required: 'เลือกเส้นทาง provider ง่ายๆ ที่นี่ OAuth ขั้นสูงทำใน Hermes CLI',
    onboarding_notice_setup_already_ready: 'ตรวจพบการตั้งค่า provider ที่ใช้งานได้แล้ว เก็บไว้หรือเปลี่ยนได้',
    onboarding_oauth_provider_ready_title: 'ยืนยัน provider แล้ว',
    onboarding_oauth_provider_ready_body: 'อินสแตนซ์นี้ใช้ OAuth provider (<strong>{provider}</strong>) และยืนยันแล้ว',
    onboarding_oauth_provider_not_ready_title: 'ยังไม่ยืนยัน OAuth provider',
    onboarding_oauth_provider_not_ready_body: 'อินสแตนซ์นี้ใช้ <strong>{provider}</strong> ซึ่งใช้ OAuth แต่ยังไม่ยืนยัน',
    onboarding_oauth_switch_hint: 'หรือเลือก provider อื่นด้านล่างเพื่อเปลี่ยนเป็น API key:',
    oauth_login_codex: 'เข้าสู่ระบบด้วย Codex (ChatGPT)',
    oauth_codex_step1: 'ขั้นที่ 1: เปิด URL นี้แล้วป้อนรหัส',
    oauth_codex_step2: 'ขั้นที่ 2: ป้อนรหัสนี้บนหน้าเว็บ',
    oauth_codex_polling: 'กำลังรอการอนุญาต...',
    oauth_codex_success: 'เข้าสู่ระบบ Codex OAuth สำเร็จ!',
    oauth_codex_error: 'เข้าสู่ระบบ OAuth ไม่สำเร็จ',
    oauth_codex_expired: 'รหัสหมดอายุ ลองใหม่',
    onboarding_notice_workspace: 'ค่าเหล่านี้ใช้ API การตั้งค่าเดียวกับแอปปกติ',
    onboarding_workspace_label: 'Workspace',
    onboarding_workspace_or_path: 'หรือป้อนพาธ workspace',
    onboarding_workspace_placeholder: '/home/you/workspace',
    onboarding_provider_label: 'โหมดตั้งค่า',
    onboarding_quick_setup_badge: 'ตั้งค่าเร็ว',
    provider_category_easy_start: 'เริ่มง่าย',
    provider_category_self_hosted: 'Open / self-hosted',
    provider_category_specialized: 'เฉพาะทาง',
    onboarding_api_key_label: 'API key',
    onboarding_api_key_placeholder: 'ว่างไว้เพื่อเก็บ key ที่บันทึกไว้',
    onboarding_api_key_label_optional: 'API key (ไม่บังคับ)',
    onboarding_api_key_placeholder_optional: 'ว่างไว้สำหรับเซิร์ฟเวอร์ไม่ใช้ key',
    onboarding_api_key_help_keyless: 'LM Studio / Ollama / vLLM ส่วนใหญ่ไม่ใช้ key — ว่างไว้ถ้าเซิร์ฟเวอร์ไม่ต้องการ',
    onboarding_api_key_help_prefix: 'บันทึกเป็นความลับในไฟล์ .env ของ Hermes ด้วย',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: 'ใช้กับ router ที่เข้ากันได้ OpenAI เซิร์ฟเวอร์ self-hosted LiteLLM Ollama ฯลฯ',
    onboarding_model_label: 'โมเดลเริ่มต้น',
    onboarding_workspace_help: 'เลือกโมเดลที่ Hermes ใช้สำหรับแชทใหม่หลังตั้งค่าเสร็จ',
    onboarding_custom_model_placeholder: 'your-model-name',
    onboarding_custom_model_help: 'สำหรับ endpoint กำหนดเอง ป้อนรหัสโมเดลที่เซิร์ฟเวอร์ต้องการ',
    onboarding_notice_password_enabled: 'ตั้งรหัสผ่านแล้ว ป้อนใหม่เฉพาะเมื่อต้องการเปลี่ยน',
    onboarding_notice_password_recommended: 'ไม่บังคับแต่แนะนำหากเปิด UI นอก localhost',
    onboarding_password_label: 'รหัสผ่าน (ไม่บังคับ)',
    onboarding_password_placeholder: 'ว่างไว้เพื่อข้าม',
    onboarding_password_help: 'รหัสผ่านเก็บผ่าน settings API และ hash ฝั่งเซิร์ฟเวอร์',
    onboarding_notice_finish: 'เปิด Settings ภายหลังเพื่อเปลี่ยนค่าใดก็ได้',
    onboarding_not_set: 'ยังไม่ตั้ง',
    onboarding_password_will_enable: 'จะเปิดใช้',
    onboarding_password_will_replace: 'จะแทนที่',
    onboarding_password_keep_existing: 'เก็บรหัสผ่านปัจจุบัน',
    onboarding_password_remains_disabled: 'จะยังปิดอยู่',
    onboarding_password_skipped: 'ข้ามไปก่อน',
    onboarding_finish_help: 'เมื่อเสร็จจะบันทึก <code>onboarding_completed</code> ใน settings แล้วเข้าแอป',
    onboarding_error_choose_workspace: 'เลือก workspace ก่อนดำเนินการต่อ',
    onboarding_error_choose_model: 'เลือกโมเดลก่อนดำเนินการต่อ',
    onboarding_error_provider_required: 'เลือกโหมดตั้งค่าก่อนดำเนินการต่อ',
    onboarding_error_base_url_required: 'ต้องระบุ Base URL สำหรับ endpoint กำหนดเอง',
    onboarding_probe_test_button: 'ทดสอบการเชื่อมต่อ',
    onboarding_probe_probing: 'กำลังทดสอบการเชื่อมต่อ\u2026',
    onboarding_probe_ok: 'เชื่อมต่อได้ มี {n} โมเดล',
    onboarding_probe_error_generic: 'เข้าถึง base URL ที่ตั้งไว้ไม่ได้',
    onboarding_probe_error_invalid_url: 'Base URL ต้องขึ้นต้นด้วย http:// หรือ https://',
    onboarding_probe_error_dns: 'แก้ host ไม่ได้ ตรวจ URL หรือใช้ IP ของ host',
    onboarding_probe_error_connect_refused: 'การเชื่อมต่อถูกปฏิเสธ — เซิร์ฟเวอร์อาจไม่ทำงานที่ที่อยู่นั้น',
    onboarding_probe_error_timeout: 'endpoint ไม่ตอบทันเวลา ตรวจว่าเซิร์ฟเวอร์ทำงานและ URL ถูกต้อง',
    onboarding_probe_error_http_4xx: 'endpoint ส่ง client error ตรวจ auth และพาธ URL',
    onboarding_probe_error_http_5xx: 'endpoint ส่ง server error ตรวจ log ของ LM Studio / Ollama',
    onboarding_probe_error_parse: 'endpoint ไม่ส่งรายการโมเดลในรูปแบบที่คาดไว้ ตรวจ URL และ API',
    onboarding_probe_error_unreachable: 'เข้าถึง base URL ที่ตั้งไว้ไม่ได้',
    onboarding_error_probe_failed: 'ตรวจสอบ base URL ที่ตั้งไว้ไม่ได้',
    onboarding_error_workspace_required: 'ต้องระบุ workspace',
    onboarding_error_model_required: 'ต้องระบุโมเดล',
    onboarding_complete: 'ตั้งค่าเสร็จแล้ว',
    ...
    remove_failed: 'ลบออกไม่สำเร็จ: ',
    switch_failed: 'สลับไม่สำเร็จ: ',
    name_required: 'ต้องระบุชื่อ',
    content_required: 'ต้องระบุเนื้อหา',
    view: 'ดู',
    dismiss: 'ปิด',
    disable: 'ปิดใช้งาน',
    cron_no_jobs: 'ไม่พบงานที่กำหนดเวลา',
    cron_status_off: 'ปิด',
    cron_status_paused: 'หยุดชั่วคราว',
    cron_status_error: 'ข้อผิดพลาด',
    cron_status_active: 'ใช้งาน',
    cron_status_running: 'กำลังทำงาน\u2026',
    cron_status_needs_attention: 'ต้องดูแล',
    cron_attention_desc: 'งานซ้ำนี้ไม่มีเวลารันถัดไป scheduler อาจคำนวณไม่ได้',
    cron_attention_croniter_hint: 'Gateway runtime อาจขาดแพ็กเกจ croniter รีสตาร์ท Gateway พร้อม croniter',
    cron_attention_resume: 'ดำเนินต่อและคำนวณใหม่',
    cron_jobs_project: 'Cron Jobs',
    cron_attention_run_once: 'รันครั้งเดียวตอนนี้',
    cron_attention_copy_diagnostics: 'คัดลอก diagnostics',
    cron_diagnostics_copied: 'คัดลอก cron diagnostics แล้ว',
    cron_next: 'ถัดไป',
    cron_last: 'ล่าสุด',
    cron_run_now: 'รันตอนนี้',
    cron_pause: 'หยุดชั่วคราว',
    cron_resume: 'ดำเนินต่อ',
    cron_job_name_placeholder: 'ชื่องาน',
    cron_schedule_placeholder: 'ตารางเวลา',
    cron_prompt_placeholder: 'Prompt',
    cron_last_output: 'ผลลัพธ์ล่าสุด',
    cron_expand_prompt: 'ขยาย prompt',
    cron_collapse_prompt: 'ย่อ prompt',
    cron_expand_output: 'ขยายผลลัพธ์',
    cron_collapse_output: 'ย่อผลลัพธ์',
    cron_all_runs: 'รันทั้งหมด',
    cron_hide_runs: 'ซ่อนรัน',
    cron_no_runs_yet: '(ยังไม่มีรัน)',
    cron_schedule_required_example: 'ต้องระบุตาราง (เช่น "0 9 * * *" หรือ "every 1h")',
    cron_schedule_required: 'ต้องระบุตารางเวลา',
    cron_prompt_required: 'ต้องระบุ prompt',
    cron_job_created: 'สร้างงานแล้ว',
    cron_duplicate: 'ทำสำเนา',
    cron_duplicated: 'ทำสำเนางานแล้ว (หยุดชั่วคราว)',
    cron_job_triggered: 'เรียกงานแล้ว',
    cron_job_paused: 'หยุดงานชั่วคราวแล้ว',
    cron_job_resumed: 'ดำเนินงานต่อแล้ว',
    cron_job_updated: 'อัปเดตงานแล้ว',
    cron_delete_confirm_title: 'ลบ cron job',
    cron_delete_confirm_message: 'การกระทำนี้ไม่สามารถย้อนกลับได้',
    cron_job_deleted: 'ลบงานแล้ว',
    cron_completion_status: (name, status) => `Cron "${name}" ${status}`,
    status_failed: 'ล้มเหลว',
    status_completed: 'เสร็จแล้ว',
    todos_no_active: 'ไม่มีรายการงานที่ใช้งานในเซสชันนี้',
    clear_conversation_title: 'ล้างบทสนทนา',
    clear_conversation_message: 'ล้างข้อความทั้งหมดหรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้',
    clear_failed: 'ล้างไม่สำเร็จ: ',
    skills_no_match: 'ไม่พบ skill ที่ตรงกัน',
    skill_enabled: 'เปิดใช้งาน',
    skill_disabled: 'ปิดใช้งาน',
    skill_toggle_failed: 'สลับ skill ไม่สำเร็จ: ',
    linked_files: 'ไฟล์ที่เชื่อมโยง',
    skill_load_failed: 'โหลด skill ไม่ได้: ',
    skill_file_load_failed: 'โหลดไฟล์ไม่ได้: ',
    skill_name_required: 'ต้องระบุชื่อ skill',
    skill_updated: 'อัปเดต skill แล้ว',
    skill_created: 'สร้าง skill แล้ว',
    skill_deleted: 'ลบ skill แล้ว',
    skill_delete_confirm: 'ลบ skill "{0}" หรือไม่?',
    skills_empty_title: 'เลือก skill',
    skills_empty_sub: 'เลือก skill จากแถบด้านข้างเพื่อดูเนื้อหา หรือสร้างใหม่',
    skills_edit: 'แก้ไข',
    skills_delete: 'ลบ',
    skills_back_to: 'กลับไป {0}',
    tasks_empty_title: 'เลือกงานที่กำหนดเวลา',
    tasks_empty_sub: 'เลือกงานจากแถบด้านข้างเพื่อดูรายละเอียดและรัน หรือสร้างใหม่',
    workspaces_empty_title: 'เลือก space',
    workspaces_empty_sub: 'แต่ละโปรไฟล์มี workspace หนึ่ง สร้างอัตโนมัติเมื่อสร้างโปรไฟล์',
    profiles_empty_title: 'เลือกโปรไฟล์',
    profiles_empty_sub: 'เลือกโปรไฟล์ agent จากแถบด้านข้างเพื่อดูและแก้ไข หรือสร้างใหม่',
    memory_notes_label: 'หน่วยความจำ (notes)',
    memory_saved: 'บันทึกหน่วยความจำแล้ว',
    my_notes: 'โน้ตของฉัน',
    user_profile: 'โปรไฟล์ผู้ใช้',
    external_notes_sources: 'โน้ตจากบุคคลที่สาม',
    external_notes_empty: 'ยังไม่เห็นแหล่งโน้ตหรือความรู้ MCP ตั้งค่า Joplin, Obsidian ฯลฯ ใน config',
    external_notes_auto_recall_hint: 'การเรียกคืนอัตโนมัติในเซสชันไม่เปลี่ยน ลิ้นชีนนี้แสดงแหล่งที่ตั้งค่า',
    external_notes_no_tools: 'ยังไม่เห็นเครื่องมืออ่าน/ค้นหาสำหรับแหล่งนี้',
    external_notes_tool_count: (count) => `${count} เครื่องมือโน้ต${Number(count)===1?'':'s'} พร้อมใช้`,
    external_notes_configured_hint: 'ชื่อเครื่องมือคาดจากแหล่งที่ตั้งค่า schema สดจะแสดงเมื่อ MCP เชื่อมต่อ',
    external_notes_recent_ai: 'AI ใช้ล่าสุด',
    external_notes_auto: 'auto',
    external_notes_recent_ai_reason: 'เรียกคืนอัตโนมัติ',
    external_notes_search_placeholder: 'ค้นหาโน้ต\u2026',
    external_notes_search_empty: 'ค้นหาแหล่งโน้ตที่ตั้งค่าเพื่อดูตัวอย่างที่นี่',
    source_active: 'ใช้งาน',
    source_configured: 'ตั้งค่าแล้ว',
    no_notes_yet: 'ยังไม่มีโน้ต',
    no_profile_yet: 'ยังไม่มีโปรไฟล์',
    agent_soul: 'Agent Soul',
    no_soul_yet: 'ยังไม่ได้กำหนด soul',
    workspace_choose_path: 'เลือกพาธ workspace',
    workspace_choose_path_meta: 'เพิ่มพาธที่ตรวจสอบแล้วและสลับบทสนทนานี้',
    workspace_manage: 'จัดการ workspaces',
    workspace_manage_meta: 'เปิดแผง Spaces',
    workspace_use_title: 'ใช้ในเซสชันปัจจุบัน',
    workspace_use: 'ใช้',
    workspace_add_path_placeholder: 'เพิ่มพาธ workspace (เช่น /home/user/my-project)',
    workspace_paths_validated_hint: 'พาธจะตรวจว่าเป็นไดเรกทอรีที่มีอยู่ก่อนบันทึก',
    workspace_one_per_profile: 'แต่ละโปรไฟล์มี workspace หนึ่ง สร้างอัตโนมัติใต้ไดเรกทอรีโปรไฟล์',
    workspace_nested_hint: 'สร้าง sub-workspace ใต้ /workspace (โฟลเดอร์ใน workspace ของโปรไฟล์คุณ) ไม่สามารถลบ root /workspace ได้',
    workspace_nested_create_hint: 'ตั้งชื่อโฟลเดอร์ (เช่น project1) ระบบจะสร้างใต้ /workspace หรือ parent ที่เลือก',
    workspace_nested_path_preview: 'เส้นทางที่แสดงใช้ /workspace เป็นรูท',
    workspace_nested_name_placeholder: 'project1',
    workspace_parent_label: 'Workspace แม่',
    workspace_name_required: 'ต้องระบุชื่อ',
    workspace_add_blocked: 'แต่ละโปรไฟล์มีได้เพียงหนึ่ง workspace',
    workspace_remove_blocked: 'ลบ workspace ของโปรไฟล์ไม่ได้',

    workspace_drag_hint: 'ลากเพื่อจัดลำดับ',
    workspace_reorder_failed: 'จัดลำดับไม่สำเร็จ',
    workspace_added: 'เพิ่ม workspace แล้ว',
    workspace_renamed: 'เปลี่ยนชื่อ workspace แล้ว',
    workspace_remove_confirm_title: 'ลบ workspace',
    workspace_remove_confirm_message: (path) => `ลบ "${path}" หรือไม่?`,
    workspace_removed: 'ลบ workspace แล้ว',
    workspace_switch_prompt_title: 'สลับ workspace',
    workspace_switch_prompt_message: 'ป้อนพาธ workspace แบบ absolute เพื่อเพิ่มและสลับบทสนทนานี้',
    workspace_switch_prompt_confirm: 'สลับ',
    workspace_switch_prompt_placeholder: '/Users/you/project',
    workspace_not_added: 'ไม่ได้เพิ่ม workspace',
    workspace_already_saved: 'บันทึก workspace แล้ว — เลือกจากรายการ',
    workspace_busy_switch: 'สลับ workspace ไม่ได้ขณะ agent กำลังทำงาน',
    discard_file_edits_title: 'ทิ้งการแก้ไขไฟล์?',
    discard_file_edits_message: 'การสลับ workspace จะทิ้งการแก้ไขที่ยังไม่บันทึกในตัวอย่าง',
    workspace_switched_to: (name) => `สลับไป ${name} แล้ว`,
    profiles_no_profiles: 'ไม่พบโปรไฟล์',
    profile_api_keys_configured: 'ตั้งค่า API keys แล้ว',
    profile_gateway_running: 'Gateway ทำงาน',
    profile_gateway_stopped: 'Gateway หยุด',
    profile_active: 'ใช้งาน',
    profile_no_configuration: 'ไม่มีการตั้งค่า',
    profile_skill_count: (count) => `${count} skill${count === 1 ? '' : 's'}`,
    profile_use: 'ใช้',
    profile_switch_title: 'สลับไปโปรไฟล์นี้',
    profile_delete_title: 'ลบโปรไฟล์นี้',
    profile_default_label: '(ค่าเริ่มต้น)',
    profile_name_placeholder: 'ชื่อโปรไฟล์ (ตัวพิมพ์เล็ก a-z 0-9 ขีด)',
    profile_clone_label: 'คัดลอกการตั้งค่า skills และ config จากโปรไฟล์เริ่มต้น ปรับหลังสร้าง',
    profile_model_label: 'โมเดล / provider',
    profile_model_hint: 'เลือกจาก providers และโมเดลที่ตั้งค่าสำหรับโปรไฟล์ใหม่',
    profile_model_use_default: 'ใช้ค่าเริ่มต้นของโปรไฟล์ที่ใช้งาน',
    profile_base_url_placeholder: 'Base URL (ไม่บังคับ เช่น http://localhost:11434)',
    profile_api_key_placeholder: 'API key (ไม่บังคับ)',
    manage_profiles: 'จัดการโปรไฟล์',
    profiles_load_failed: 'โหลดโปรไฟล์ไม่สำเร็จ',
    profile_switched_new_conversation: (name) => `สลับไปโปรไฟล์: ${name} — เริ่มบทสนทนาใหม่แล้ว`,
    profile_switched: (name) => `สลับไปโปรไฟล์: ${name}`,
    profile_name_rule: 'ใช้ได้เฉพาะตัวพิมพ์เล็ก ตัวเลข ขีด และ underscore',
    profile_base_url_rule: 'Base URL ต้องขึ้นต้นด้วย http:// หรือ https://',
    profile_created: (name) => `สร้างโปรไฟล์แล้ว: ${name}`,
    profile_delete_confirm_title: (name) => `ลบโปรไฟล์ "${name}" หรือไม่?`,
    profile_delete_confirm_message: 'เซสชัน config skills และหน่วยความจำของโปรไฟล์นี้จะถูกลบถาวร',
    profile_deleted: (name) => `ลบโปรไฟล์แล้ว: ${name}`,

    profile_sync_from_default_title: 'อัปเดตจาก default',
    profile_sync_from_default_hint: 'คัดลอก config, MCP servers, skills และย่อหน้า agent soul ที่ยังไม่มีจาก default profile โดยไม่แก้เนื้อหาเดิมของ profile นี้',
    profile_sync_from_default_confirm_title: (name) => `อัปเดต "${name}" จาก default?`,
    profile_sync_from_default_confirm_message: 'จะคัดลอกเฉพาะรายการที่ profile นี้ยังไม่มีจาก default profile',
    profile_sync_from_default_done: (name) => `อัปเดตโปรไฟล์จาก default แล้ว: ${name}`,
    profile_sync_all_from_default_title: 'อัปเดตทุกโปรไฟล์จาก default',
    profile_sync_all_from_default_confirm_title: 'อัปเดตทุกโปรไฟล์จาก default?',
    profile_sync_all_from_default_confirm_message: 'ทุกโปรไฟล์ที่ไม่ใช่ default จะได้รับ config, MCP servers, skills และ agent soul ที่ยังไม่มีจาก default profile โดยไม่แก้ของเดิม',
    profile_sync_all_from_default_done: (count) => `อัปเดต ${count} โปรไฟล์จาก default แล้ว`,
    profile_sync_failed: 'อัปเดตโปรไฟล์ไม่สำเร็จ: ',

    profile_sync_panel_hint: 'กด refresh เพื่อคัดลอก config, MCP, skills และ agent soul ที่ยังไม่มีจาก default profile',
    profile_sync_items_label: 'รายการที่ sync',
    profile_sync_items_config: 'Config',
    profile_sync_items_mcp: 'MCP servers',
    profile_sync_items_skills: 'Skills',
    profile_sync_items_soul: 'Agent soul',
    profile_sync_added_config: (count) => `config ${count} รายการ`,
    profile_sync_added_mcp: (count) => `MCP ${count} ตัว`,
    profile_sync_added_skills: (count) => `skills ${count} รายการ`,
    profile_sync_added_soul: (count) => `soul ${count} ไฟล์`,
    profile_sync_result_added: (summary) => `เพิ่มจาก default: ${summary}`,
    profile_sync_result_none: 'อัปเดตครบแล้ว — ไม่มีรายการใหม่จาก default',
    active_conversation_none: 'ยังไม่ได้เลือกบทสนทนาที่ใช้งาน',
    active_conversation_meta: (title, count) => `${title} · ${count} ข้อความ`,
    settings_unsaved_changes: 'มีการเปลี่ยนแปลงที่ยังไม่ได้บันทึก',
    sign_out_failed: 'ออกจากระบบไม่สำเร็จ: ',
    disable_auth_confirm_title: 'ปิดการป้องกันด้วยรหัสผ่าน',
    disable_auth_confirm_message: 'ทุกคนจะเข้าถึงอินสแตนซ์นี้ได้',
    auth_disabled: 'ปิด auth แล้ว — ลบการป้องกันรหัสผ่าน',
    disable_auth_failed: 'ปิด auth ไม่สำเร็จ: ',
    bg_error_single: (title) => `"${title}" เกิดข้อผิดพลาด`,
    bg_error_multi: (count) => `${count} เซสชันเกิดข้อผิดพลาด`,
    // skill form
    skill_name: 'ชื่อ',
    skill_category: 'หมวดหมู่',
    skill_category_placeholder: 'ไม่บังคับ เช่น devops',
    skill_content: 'เนื้อหา SKILL.md',
    skill_content_placeholder: 'YAML frontmatter + markdown body',
    skill_rename_not_supported: 'เปลี่ยนชื่อ skill ไม่รองรับ สร้างใหม่แล้วลบของเก่า',
    skill_metadata: 'Metadata',
    // cron form
    cron_name_label: 'ชื่อ',
    cron_name_placeholder: 'ไม่บังคับ',
    cron_schedule_label: 'ตารางเวลา',
    cron_schedule_hint: 'ใช้ \'every 1h\' หรือ cron expression สำหรับงานซ้ำ ระยะเวลาเปล่าเช่น \'30m\' รันครั้งเดียว',
    cron_schedule_once_warning: 'รูปแบบระยะเวลาเช่น \'30m\' รันครั้งเดียวและถูกลบหลังรัน ใช้ \'every 30m\' สำหรับซ้ำ',
    cron_prompt_label: 'Prompt',
    cron_deliver_label: 'ส่งผลลัพธ์ไปที่',
    cron_deliver_local: 'Local (บันทึกผลลัพธ์เท่านั้น)',
    cron_deliver_custom: 'เป้าหมายส่งกำหนดเอง',
    cron_profile_label: 'โปรไฟล์',
    cron_profile_server_default: 'ค่าเริ่มต้นของเซิร์ฟเวอร์',
    cron_profile_server_default_hint: 'ใช้โปรไฟล์เริ่มต้นของ WebUI server ตอนรัน งานเก่าไม่มีโปรไฟล์ก็ใช้ค่านี้',
    cron_toast_notifications_label: 'Toast เมื่องานเสร็จ',
    cron_toast_notifications_hint: 'แสดง toast เมื่อ cron นี้เสร็จ badge Tasks และตัวบอกรันใหม่ยังทำงาน',
    cron_toast_notifications_enabled: 'เปิด',
    cron_toast_notifications_disabled: 'ปิด',
    cron_skills_label: 'Skills',
    cron_skills_placeholder: 'เพิ่ม skills (ไม่บังคับ)\u2026',
    cron_skills_edit_hint: 'แก้รายการ skill หลังสร้างไม่ได้',
    // workspace form
    workspace_name_label: 'ชื่อ',
    workspace_name_placeholder: 'ชื่อที่อ่านง่าย (ไม่บังคับ)',
    workspace_path_label: 'พาธ',
    workspace_path_required: 'ต้องระบุพาธ',
    workspace_path_readonly: 'เปลี่ยนพาธไม่ได้ เปลี่ยนได้เฉพาะชื่อ',
    workspace_new_title: 'Space ใหม่',
    // profile form
    profile_name_label: 'ชื่อ',
    profile_base_url_label: 'Base URL',
    profile_api_key_label: 'API key',
    cmd_yolo: 'สลับโหมด YOLO (ข้ามการอนุมัติ)',
    yolo_no_session: 'ไม่มีเซสชันที่ใช้งาน',
    yolo_enabled: '⚡ เปิดโหมด YOLO — ข้ามการอนุมัติในเซสชันนี้',
    yolo_disabled: 'ปิดโหมด YOLO',
    yolo_pill_label: 'YOLO',
    yolo_pill_title_active: 'โหมด YOLO เปิดอยู่ — คลิกเพื่อปิด',
    approval_skip_all: '⚡ ข้ามทั้งหมดในเซสชันนี้',
    approval_skip_all_title: 'ข้ามการขออนุมัติทั้งหมดในเซสชันนี้',
    // composer action tooltips
    composer_send: 'ส่งข้อความ',
    composer_queue: 'คิวข้อความ',
    composer_interrupt: 'หยุดแล้วส่ง',
    composer_steer: 'Steer คำตอบปัจจุบัน',
    composer_stop: 'หยุดการสร้าง',
    composer_disabled_clarify: 'ตอบคำขอชี้แจง',
    composer_disabled_compression: 'รอการบีบอัดให้เสร็จ',
    composer_disabled_empty: 'พิมพ์ข้อความเพื่อส่ง',
    composer_mobile_workspace: 'Workspace',
    composer_mobile_model: 'โมเดล',
    composer_mobile_reasoning: 'Reasoning',
    composer_mobile_context: 'บริบท',
    media_audio_label: 'เสียง',
    media_svg_label: 'Diagram',
    media_video_label: 'วิดีโอ',
    csv_loading: 'กำลังโหลด CSV',
    csv_too_large: 'ไฟล์ CSV ใหญ่เกินไปสำหรับแสดงในหน้า',
    csv_no_data: 'ไฟล์ CSV มีข้อมูลไม่พอสำหรับตาราง',
    csv_error: 'โหลดไฟล์ CSV ไม่สำเร็จ',
    csv_header_note: 'แถวแรกแสดงเป็นหัวตาราง',
    excalidraw_loading: 'กำลังโหลด diagram',
    excalidraw_too_large: 'ไฟล์ Excalidraw ใหญ่เกินไปสำหรับแสดงในหน้า',
    excalidraw_invalid: 'รูปแบบไฟล์ Excalidraw ไม่ถูกต้อง',
    excalidraw_error: 'โหลดไฟล์ Excalidraw ไม่สำเร็จ',
    excalidraw_label: 'Diagram',
    excalidraw_download: 'ดาวน์โหลด',
    excalidraw_empty: 'ไดอagram ว่าง',
    excalidraw_render_error: 'แสดงไดอagram ไม่สำเร็จ',
    excalidraw_simplified: 'ตัวอย่าง SVG แบบย่อ — ไม่เหมือน canvas Excalidraw ทุกพิกเซล',
    // ── Checkpoints / Rollback ──
    checkpoint_title: 'Checkpoints',
    checkpoint_empty: 'ไม่พบ checkpoint สำหรับ workspace นี้',
    checkpoint_loading: 'กำลังโหลด checkpoints\u2026',
    checkpoint_error: 'โหลด checkpoints ไม่สำเร็จ',
    checkpoint_date: 'วันที่',
    checkpoint_message: 'ข้อความ',
    checkpoint_files: 'ไฟล์',
    checkpoint_view_diff: 'ดู diff',
    checkpoint_restore: 'กู้คืน',
    checkpoint_restore_confirm_title: 'กู้คืน checkpoint?',
    checkpoint_restore_confirm_message: (ckpt) => `กู้คืน workspace ไป checkpoint "${ckpt}" หรือไม่? จะเขียนทับไฟล์ใน workspace`,
    checkpoint_restored: 'กู้คืน checkpoint แล้ว',
    checkpoint_diff_title: 'การเปลี่ยนแปลงใน checkpoint',
    checkpoint_diff_no_changes: 'ไม่พบความต่างระหว่าง checkpoint นี้กับ workspace ปัจจุบัน',
    checkpoint_diff_files_changed: (n) => `${n} ไฟล์ที่เปลี่ยน`,
  ...
  tr: {
    ...
    mcp_edit_server: 'MCP Sunucusunu Düzenle',
    profile_tab_overview: 'Genel Bakış',
    profile_mcp_desc: 'Bu profilin config.yaml dosyasında saklanan MCP sunucuları.',
    profile_mcp_reload_hint: 'Bu sekmeyi açtığınızda veya değişiklikleri kaydettiğinizde MCP sunucuları otomatik olarak bağlanır.',
    mcp_status_error: 'Bağlantı başarısız',
    mcp_connect_failed_summary: 'Bazı MCP sunucuları bağlanamadı',
    mcp_updating: 'Bağlantı durumu güncelleniyor…',
    mcp_connecting: 'MCP sunucularına bağlanılıyor…',
    mcp_input_form: 'Form',
    mcp_json_label: 'MCP sunucu JSON',
    mcp_json_hint: 'config.yaml mcp_servers gibi adı anahtar olan bir veya daha fazla sunucu yapıştırın.',
    mcp_json_required: 'JSON gerekli.',
    mcp_json_invalid: 'Geçersiz JSON.',
    mcp_json_object_required: 'JSON bir nesne olmalıdır.',
    mcp_json_no_servers: 'JSON\'da MCP sunucu girişi bulunamadı.',
    mcp_json_entry_invalid: 'Sunucu için geçersiz yapılandırma',
    mcp_json_entry_missing_transport: 'Her sunucunun url veya command gerekir',
    mcp_json_edit_single: 'Düzenleme JSON\'u yalnızca geçerli sunucu adını içermelidir.',
    ...
    tab_kanban: 'Kanban',
    kanban_subtitle: 'Ajanın kendi başına alıp tamamlayabileceği görevler için kalıcı çoklu ajan panosu.',
    kanban_dispatch: 'Gönder',
    kanban_board: 'Pano',
    ...
    kanban_priority_low: 'Düşük',
    kanban_priority_normal: 'Normal',
    kanban_priority_high: 'Yüksek',
    kanban_priority_urgent: 'Acil',
    kanban_priority_hint: 'Daha yüksek öncelik önce çalıştırılır. Varsayılan normaldir.',
    ...
    workspace_one_per_profile: 'Her profilin profil dizini altında otomatik oluşturulan bir çalışma alanı vardır.',
    workspace_add_blocked: 'Her profil yalnızca bir çalışma alanına sahip olabilir.',
    workspace_remove_blocked: 'Profil çalışma alanı kaldırılamaz.',
