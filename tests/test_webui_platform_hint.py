...
def test_streaming_uses_webui_platform():
    """app/domain/streaming.py must pass platform='webui' when constructing AIAgent."""
    streaming_py = _load_source("app/domain/streaming.py")
...
def test_routes_uses_webui_platform_for_all_agent_calls():
    """app/domain/routes.py must use platform='webui' for all AIAgent instantiations."""
    routes_py = _load_source("app/domain/routes.py")
