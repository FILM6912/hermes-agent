...
CSS = (REPO_ROOT / "static-legacy" / "style.css").read_text()
HTML = (REPO_ROOT / "static" / "index.html").read_text()
MESSAGES_JS = (REPO_ROOT / "static-legacy" / "messages.js").read_text()
...
class TestIssue495TitleStreaming(unittest.TestCase):
    ...
    def test_streaming_emits_stream_end_event(self):
        self.assertIn(
            ...
            STREAMING_PY,
            "streaming should end the SSE stream with stream_end before background title work",
        )
    ...
    def test_title_snippet_uses_visible_assistant_reply_after_tools(self):
        ...
        from app.domain.streaming import _first_exchange_snippets
    ...
    def test_provisional_title_detection_ignores_whitespace_noise(self):
        ...
        from app.domain.streaming import _is_provisional_title, title_from
    ...
    def test_fallback_title_preserves_unicode_letters(self):
        ...
        from app.domain.streaming import _fallback_title_from_exchange
