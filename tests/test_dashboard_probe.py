...
def test_dashboard_target_validation_allows_only_loopback_base_urls():
    from app.domain.dashboard_probe import normalize_dashboard_url
...
def test_dashboard_browser_url_preserves_ipv6_host_brackets():
    from app.domain.dashboard_probe import normalize_dashboard_browser_url
...
def test_dashboard_config_roundtrip_writes_profile_config_yaml(tmp_path, monkeypatch):
    ...
    from app.domain.dashboard_probe import get_dashboard_config, save_dashboard_config
