...
def _post_settings(body_dict, cookie=""):
    ...
    from app.domain.routes import handle_post
...
def test_post_set_password_settings_hash_unchanged_after_409(monkeypatch, tmp_path):
    ...
    from app.domain.config import load_settings, save_settings
    ...
    import app.domain.config as cfg
    isolated_settings = tmp_path / "settings.json"
    monkeypatch.setattr(cfg, "SETTINGS_FILE", isolated_settings)
...
I18N_JS = (REPO_ROOT / "static-legacy" / "i18n.js").read_text(encoding="utf-8")
