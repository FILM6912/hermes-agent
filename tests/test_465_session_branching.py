...
def test_branch_endpoint_exists():
    ...
    with open('app/domain/routes.py') as f:
        src = f.read()
...
def test_branch_fork_sessions_do_not_collapse_into_parent_lineage():
    ...
    with open('static-legacy/sessions.js') as f:
        src = f.read()
...
def test_session_model_parent_session_id():
    ...
    with open('app/domain/models.py') as f:
        src = f.read()
...
def test_branch_slash_command_registered():
    ...
    with open('static-legacy/commands.js') as f:
        src = f.read()
...
def test_fork_button_rendered_in_ui():
    ...
    with open('static-legacy/ui.js') as f:
        src = f.read()
...
def test_parent_indicator_hover_only_style():
    ...
    with open('static-legacy/style.css') as f:
        src = f.read()
    assert '.session-branch-indicator' in src, \
...
def test_i18n_branch_keys():
    ...
    with open('static-legacy/i18n.js') as f:
        src = f.read()
    required_keys = [
        'cmd_branch',
        'cmd_branch_usage',
...
def test_git_branch_icon_exists():
    ...
    with open('static-legacy/icons.js') as f:
        src = f.read()
