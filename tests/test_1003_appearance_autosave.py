...
BOOT_JS = (Path(__file__).parent.parent / "static-legacy" / "boot.js").read_text(encoding="utf-8")
PANELS_JS = (Path(__file__).parent.parent / "static-legacy" / "panels.js").read_text(encoding="utf-8")
INDEX_HTML = (Path(__file__).parent.parent / "static-legacy" / "index.html").read_text(encoding="utf-8")
I18N_JS = (Path(__file__).parent.parent / "static-legacy" / "i18n.js").read_text(encoding="utf-8")
