...
WORKSPACE_JS = Path("static-legacy/workspace.js").read_text(encoding="utf-8")
SESSIONS_JS = Path("static-legacy/sessions.js").read_text(encoding="utf-8")
MESSAGES_JS = Path("static-legacy/messages.js").read_text(encoding="utf-8")
INDEX_HTML = Path("static/index.html").read_text(encoding="utf-8")
STYLE_CSS = Path("static-legacy/style.css").read_text(encoding="utf-8")
