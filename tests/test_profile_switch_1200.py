...
def test_profile_switch_route_invalidates_models_cache(tmp_path):
    ...
    """
    from app.domain.config import invalidate_models_cache, _available_models_cache_lock
    import app.domain.config as config_module
...
def test_syncTopbar_early_return_updates_profile_chip():
    ...
    """
    from pathlib import Path
    ui_js = (Path(__file__).parent.parent / "static-legacy" / "ui.js").read_text(encoding="utf-8")
