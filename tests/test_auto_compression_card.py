...
from app.domain.compression_anchor import visible_messages_for_anchor
from app.domain.models import Session
from app.domain.streaming import _is_fallback_lifecycle_message
...
def _compressed_listener_block() -> str:
    src = _read("static-legacy/messages.js")
...
def test_agent_status_callback_emits_compressing_and_warning_events():
    src = _read("app/domain/streaming.py")
...
def test_frontend_uses_context_engine_metadata_for_indexed_context_copy():
    src = _read("static-legacy/ui.js")
    i18n = _read("static-legacy/i18n.js")
