...
class TestApprovalCardCSS:
    ...
    def test_btn_disabled_style_present(self):
        css = read(REPO / "static-legacy/style.css")
...
class TestApprovalMessagesJS:
    ...
    def test_show_approval_card_re_enables_buttons(self):
        src = read(REPO / "static-legacy/messages.js")
...
class TestApprovalKeyboardShortcut:
    ...
    def test_enter_shortcut_present_in_boot_js(self):
        src = read(REPO / "static-legacy/boot.js")
...
class TestStreamingApprovalScoping:
    ...
    def test_unreg_notify_initialised_to_none(self):
        src = read(REPO / "app/domain/streaming.py")
...
class TestApprovalCardTimerLogic:
    ...
    def _get_js(self):
        return pathlib.Path(__file__).parent.parent / 'static-legacy' / 'messages.js'
...
class TestClarifyCardTimerLogic:
    ...
    def _get_html(self):
        return pathlib.Path(__file__).parent.parent / 'static-legacy' / 'index.html'

    def _get_css(self):
        return pathlib.Path(__file__).parent.parent / 'static-legacy' / 'style.css'
