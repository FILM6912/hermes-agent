...
# ── Paths ────────────────────────────────────────────────────────────────────
_ROUTES = os.path.join(os.path.dirname(__file__), "..", "app", "domain", "routes.py")
_CLARIFY = os.path.join(os.path.dirname(__file__), "..", "app", "domain", "clarify.py")
...
def clarify_mod():
    ...
    from app.domain import clarify
    return clarify
