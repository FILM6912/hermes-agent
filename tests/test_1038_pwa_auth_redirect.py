...
def _workspace_js() -> str:
    return (ROOT / "static-legacy" / "workspace.js").read_text(encoding="utf-8")


def _ui_js() -> str:
    return (ROOT / "static-legacy" / "ui.js").read_text(encoding="utf-8")
...
class TestLoginJsSafeNextPath:
    ...
    @staticmethod
    def _login_js():
        return (Path(__file__).parent.parent / "static-legacy" / "login.js").read_text(encoding="utf-8")
