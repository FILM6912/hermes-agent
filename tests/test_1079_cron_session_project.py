...
def test_ensure_cron_project_creates_project():
    ...
    from app.domain.models import ensure_cron_project, load_projects, save_projects
...
def test_is_cron_session():
    ...
    from app.domain.models import is_cron_session
...
def test_cron_jobs_project_i18n_key_exists():
    ...
    """
    i18n_path = pathlib.Path(__file__).resolve().parent.parent / "static-legacy" / "i18n.js"
