...
def test_926_hindsight_client_in_unified_requirements():
    """Unified requirements.txt includes hindsight-client for Docker and local venv installs."""
    assert "hindsight-client" in REQUIREMENTS_TXT
