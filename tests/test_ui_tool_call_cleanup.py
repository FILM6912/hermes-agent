...
UI_JS = (REPO / "static-legacy" / "ui.js").read_text(encoding="utf-8")
BOOT_JS = (REPO / "static-legacy" / "boot.js").read_text(encoding="utf-8")
CSS = (REPO / "static-legacy" / "style.css").read_text(encoding="utf-8")
...
class TestToolCallGroupingStatic:
    def test_simplified_tool_calling_setting_is_wired_through_frontend(self):
        ...
        assert "window._simplifiedToolCalling" in (REPO / "static-legacy" / "boot.js").read_text(encoding="utf-8"), (
            "Boot should hydrate simplified_tool_calling into a runtime flag."
        )
        panels = (REPO / "static-legacy" / "panels.js").read_text(encoding="utf-8")
    ...
    def test_activity_disclosure_state_is_session_and_turn_scoped(self):
        ...
        done_fn = (REPO / "static-legacy" / "messages.js").read_text(encoding="utf-8")
