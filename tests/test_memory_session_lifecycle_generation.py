...
def _fresh_lifecycle():
    ...
    lifecycle = importlib.import_module("app.domain.session_lifecycle")
...
def test_frontend_new_session_sends_previous_session_id_boundary():
    src = (REPO / "static-legacy" / "sessions.js").read_text(encoding="utf-8")
...
def test_lru_eviction_commits_outside_cache_lock():
    ...
    import app.domain.streaming as streaming_mod
