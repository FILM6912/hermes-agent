...
def test_read_session_lineage_metadata_closes_connection(tmp_path, tracking_sqlite):
    ...
    from app.domain.agent_sessions import read_session_lineage_metadata
...
def test_get_cli_session_messages_closes_connection(tmp_path, tracking_sqlite, monkeypatch):
    ...
    import app.domain.profiles
    monkeypatch.setattr(app.domain.profiles, "get_active_hermes_home", lambda: str(tmp_path))

    from app.domain.models import get_cli_session_messages
