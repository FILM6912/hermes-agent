...
- The setting key + default + enum validation in app/domain/config.py
...
CONFIG_PY = (ROOT / "app" / "domain" / "config.py").read_text(encoding="utf-8")
COMMANDS_JS = (ROOT / "static-legacy" / "commands.js").read_text(encoding="utf-8")
MESSAGES_JS = (ROOT / "static-legacy" / "messages.js").read_text(encoding="utf-8")
UI_JS = (ROOT / "static-legacy" / "ui.js").read_text(encoding="utf-8")
BOOT_JS = (ROOT / "static-legacy" / "boot.js").read_text(encoding="utf-8")
PANELS_JS = (ROOT / "static-legacy" / "panels.js").read_text(encoding="utf-8")
INDEX_HTML = (ROOT / "static" / "index.html").read_text(encoding="utf-8")
I18N_JS = (ROOT / "static-legacy" / "i18n.js").read_text(encoding="utf-8")
