...
def test_gateway_watcher_hides_sessions_without_messages(monkeypatch):
    ...
    try:
        ...
        import app.domain.gateway_watcher as gateway_watcher
...
def test_compression_chain_collapses_to_latest_tip_in_sidebar():
    ...
    try:
        ...
        from app.domain.agent_sessions import read_importable_agent_session_rows
...
def test_agent_session_source_normalization_contract():
    ...
    from app.domain.agent_sessions import normalize_agent_session_source
...
def test_sessions_js_treats_email_as_messaging_source():
    ...
    src = (REPO_ROOT / "static-legacy" / "sessions.js").read_text(encoding="utf-8")
...
from app.domain.routes import _gateway_sse_probe_payload
...
def test_gateway_watcher_is_alive_public_method():
    ...
    from app.domain.gateway_watcher import GatewayWatcher
    w = GatewayWatcher()
