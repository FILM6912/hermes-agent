...
SESSIONS_JS_PATH = REPO_ROOT / "static-legacy" / "sessions.js"
...
def test_lineage_segment_locale_keys_are_defined_for_sidebar_locales():
    i18n = (REPO_ROOT / "static-legacy" / "i18n.js").read_text(encoding="utf-8")
    required = [
...
def test_session_meta_segments_softened_label_no_literal_segment_in_english():
    ...
    """
    import re
    i18n_text = (REPO_ROOT / 'static-legacy' / 'i18n.js').read_text(encoding='utf-8')
