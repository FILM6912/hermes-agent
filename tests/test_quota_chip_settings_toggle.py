...
PANELS = REPO_ROOT / "static-legacy" / "panels.js"
UI_JS = REPO_ROOT / "static-legacy" / "ui.js"
BOOT = REPO_ROOT / "static-legacy" / "boot.js"
I18N = REPO_ROOT / "static-legacy" / "i18n.js"
CONFIG = REPO_ROOT / "app" / "domain" / "config.py"
...
def test_quota_chip_localized_in_all_locales():
    ...
    assert js.count("settings_label_quota_chip:") == 13, "13 locales expected"
    assert js.count("settings_desc_quota_chip:") == 13, "13 locales expected"
