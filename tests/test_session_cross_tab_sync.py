...
BOOT_JS = (REPO_ROOT / "static-legacy" / "boot.js").read_text(encoding="utf-8")
COMMANDS_JS = (REPO_ROOT / "static-legacy" / "commands.js").read_text(encoding="utf-8")
...
def test_api_helper_resolves_against_document_base_not_session_path():
    workspace_js = (REPO_ROOT / "static-legacy" / "workspace.js").read_text(encoding="utf-8")
...
def test_long_lived_stream_urls_resolve_against_document_base():
    for rel in ("static-legacy/messages.js", "static-legacy/boot.js", "static-legacy/terminal.js"):
