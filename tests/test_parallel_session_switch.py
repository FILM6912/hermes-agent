...
SESSIONS_JS = (REPO / "static-legacy" / "sessions.js").read_text(encoding="utf-8")
WORKSPACE_JS = (REPO / "static-legacy" / "workspace.js").read_text(encoding="utf-8")
...
class TestGitInfoParallel:
    ...
    def test_uses_thread_pool(self):
        source = pathlib.Path(__file__).parent.parent / "app" / "domain" / "workspace.py"
    ...
    def test_git_commands_run_concurrently(self, tmp_path):
        ...
        from app.domain.workspace import git_info_for_workspace
        import app.domain.workspace as ws_mod
...
class TestScrollPositionPreservation:
    ...
    def test_uses_correct_scrollable_container(self):
        ...
        SESSIONS_JS = pathlib.Path(__file__).parent.parent / "static-legacy" / "sessions.js"
