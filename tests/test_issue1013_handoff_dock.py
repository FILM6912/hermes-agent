...
SESSIONS_JS = (ROOT / "static-legacy" / "sessions.js").read_text(encoding="utf-8")
...
def test_handoff_summary_renders_as_transcript_card_not_dock_card():
    assert "function setHandoffUi" in SESSIONS_JS or "function setHandoffUi" in (ROOT / "static-legacy" / "ui.js").read_text(encoding="utf-8")
    ui_js = (ROOT / "static-legacy" / "ui.js").read_text(encoding="utf-8")
