...
from app.domain.session_recovery import recover_missing_sidecars_from_state_db, audit_session_recovery
...
def test_materialized_sidecar_round_trips_through_session_load(tmp_path, monkeypatch):
    ...
    """
    import app.domain.models as _m
...
def test_recover_missing_sidecars_uses_per_process_tmp_suffix(tmp_path):
    ...
    src = (Path(__file__).resolve().parent.parent / "app" / "domain" / "session_recovery.py").read_text(encoding="utf-8")
