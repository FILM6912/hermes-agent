...
def test_fully_unquote_handles_quadruple_encoded(monkeypatch):
    ...
    """
    from app.domain.extensions import _fully_unquote_path
...
def test_quadruple_encoded_traversal_url_now_rejected(tmp_path, monkeypatch):
    ...
    from app.domain.extensions import get_extension_config
...
def test_url_list_caps_at_max(tmp_path, monkeypatch):
    ...
    from app.domain.extensions import get_extension_config, _MAX_URL_LIST
...
def test_url_list_logs_rejected_urls_once(tmp_path, monkeypatch, caplog):
    ...
    from app.domain.extensions import _warned_urls
    _warned_urls.clear()

    caplog.set_level(logging.WARNING, logger="app.domain.extensions")
