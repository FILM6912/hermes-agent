...
STYLE_CSS = ROOT / "static-legacy" / "style.css"
...
def test_session_search_preview_trims_long_body_with_ellipses():
    from app.domain.routes import _session_search_preview
...
def test_session_search_preview_handles_empty_or_unavailable_body():
    from app.domain.routes import _session_search_message_text, _session_search_preview
