...
>
> Primary entrypoint: `python3 -m uvicorn app.main:app --host 127.0.0.1 --port 8787`
> (also used by `bootstrap.py` and Docker init when `app/main.py` is present).
> Rollback / Windows launcher: `python3 server.py` (deprecated thin uvicorn wrapper).
>
