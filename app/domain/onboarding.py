...
from app.domain.providers import _write_env_file  # shared impl with _ENV_LOCK (#1164)
from app.domain.workspace import get_last_workspace, load_workspaces
...
_PROBE_OPENER = build_url_opener(redirect_handler=_NoRedirectHandler())
...
def apply_onboarding_setup(body: dict) -> dict:
    ...
    try:
        from app.domain.profiles import _reload_dotenv
