...
from app.domain.helpers import bad, j
...
def handle_kanban_get(handler, parsed) -> bool | None:
    ...
    """
    if parsed.path == "/api/kanban/events/stream":
        return _handle_events_sse_stream(handler, parsed)
    from app.domain.profiles import profile_request_context

    with profile_request_context():
        return _handle_kanban_get_scoped(handler, parsed)


def _handle_kanban_get_scoped(handler, parsed) -> bool | None:
    path = parsed.path
    try:
...
def handle_kanban_post(handler, parsed, body) -> bool | None:
    ...
    with profile_request_context():
        return _handle_kanban_post_scoped(handler, parsed, body)


def _handle_kanban_post_scoped(handler, parsed, body) -> bool | None:
    path = parsed.path
    try:
...
def handle_kanban_patch(handler, parsed, body) -> bool | None:
    ...
    with profile_request_context():
        return _handle_kanban_patch_scoped(handler, parsed, body)


def _handle_kanban_patch_scoped(handler, parsed, body) -> bool | None:
    path = parsed.path
    try:
...
def handle_kanban_delete(handler, parsed, body) -> bool | None:
    ...
    with profile_request_context():
        return _handle_kanban_delete_scoped(handler, parsed, body)


def _handle_kanban_delete_scoped(handler, parsed, body) -> bool | None:
    path = parsed.path
    try:
